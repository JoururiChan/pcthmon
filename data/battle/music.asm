...
BattleMusic_Legendaries:
	...
	db SKOISHI,   MUSIC_NAZRIN_BATTLE
	db CNAZRIN,    MUSIC_NAZRIN_BATTLE
	db NAZRIN,  MUSIC_NAZRIN_BATTLE
	db CICHIRIN,    MUSIC_CICHIRIN_BATTLE_HGSS
	db TKOGASA,    MUSIC_TKOGASA_BATTLE_HGSS
	db ICHIRIN,   MUSIC_NAZRIN_BATTLE
	db -1
