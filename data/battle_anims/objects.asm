...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $88, BATTLEANIMFRAMESET_88, BATTLEANIMFUNC_SAKUYA_WORLD, PAL_BATTLE_OB_BLUE, ANIM_GFX_WIND ; ANIM_OBJ_SAKUYA_WORLD
	...
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS ; ANIM_OBJ_SHELL_SMASH
