...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_MOVE_IN_CIRCLE, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_METEOR_FALL
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_HELL_TOKAMAK, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_HELL_TOKAMAK
	...
	battleanimobj RELATIVE_X, $40, BATTLEANIMFRAMESET_2B, BATTLEANIMFUNC_POWDER, PAL_BATTLE_OB_GRAY, ANIM_GFX_POWDER ; ANIM_OBJ_POWDER
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_46, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_WHIP ; ANIM_OBJ_VINE_WHIP1
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_47, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_WHIP ; ANIM_OBJ_VINE_WHIP2
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_6A, BATTLEANIMFUNC_STRING, PAL_BATTLE_OB_GRAY, ANIM_GFX_WEB ; ANIM_OBJ_DOLL_STRINGS
	...
	battleanimobj RELATIVE_X, $48, BATTLEANIMFRAMESET_73, BATTLEANIMFUNC_PETAL_SLASH, PAL_BATTLE_OB_RED, ANIM_GFX_FLOWER ; ANIM_OBJ_PETAL_SLASH
	...
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $88, BATTLEANIMFRAMESET_88, BATTLEANIMFUNC_SPIDERS_NEST, PAL_BATTLE_OB_BLUE, ANIM_GFX_WIND ; ANIM_OBJ_SPIDERS_NEST
	...
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_SHINY_FIRE, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_SHINY_FIRE
	...
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, ANIM_GFX_EGG ; ANIM_OBJ_BLACK_RIPPLE
	...
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_OBJ_MOONBLAST
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_MOON, PAL_BATTLE_OB_GRAY, ANIM_GFX_GLOBE ; ANIM_OBJ_MOON
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_RECOVER, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_OBJ_MOON_CHARGE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_GREEN, ANIM_GFX_EGG ; ANIM_OBJ_DREAM_HEAVEN
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_FOCUS_BLAST, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_OBJ_FOCUS_BLAST
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; ANIM_OBJ_BIG_ICE_CHUNK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; ANIM_OBJ_SMALL_ICE_CHUNK
	battleanimobj RELATIVE_X| X_FLIP, $80, BATTLEANIMFRAMESET_3E, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_HONE_TOOLS_LEFT
	battleanimobj RELATIVE_X| X_FLIP, $80, BATTLEANIMFRAMESET_3F, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_HONE_TOOLS_RIGHT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, ANIM_GFX_EGG ; ANIM_OBJ_ROCK_BLAST
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_7F, BATTLEANIMFUNC_SHADOW_DANCE, PAL_BATTLE_OB_GRAY, ANIM_GFX_WHIP ; ANIM_OBJ_TRICK_ROOM
	...
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_SPEED ; ANIM_OBJ_STAT_UP (palette dynamically loaded)
	battleanimobj RELATIVE_X, $54, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_STRAIGHT_DESCENT, PAL_BATTLE_OB_GRAY, ANIM_GFX_SPEED ; ANIM_OBJ_STAT_DOWN (palette dynamically loaded)
	...
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_LAVATEIN
	...
	battleanimobj RELATIVE_X | X_FLIP, $88, BATTLEANIMFRAMESET_7B, BATTLEANIMFUNC_PAUSE_THEN_RUSH, PAL_BATTLE_OB_GRAY, ANIM_GFX_SKY_ATTACK ; ANIM_OBJ_DIVE_KICK
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_FLASH_CANNON, BATTLEANIMFUNC_POWER_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHARGE ; ANIM_OBJ_FLASH_CANNON
	battleanimobj RELATIVE_X | X_FLIP, $9a, BATTLEANIMFRAMESET_VORTEX, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_LEAF_STORM ; ANIM_OBJ_VORTEX_YELLOW
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_YELLOW, ANIM_GFX_STARS ; ANIM_OBJ_STAR_BURST
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_RED, ANIM_GFX_HEARTS ; ANIM_OBJ_HEART_BURST
	...
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS ; ANIM_OBJ_POWER_TRICK
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_7D, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_REFLECT ; ANIM_OBJ_POWER_TRICK_SHELL
