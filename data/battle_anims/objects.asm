...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $88, BATTLEANIMFRAMESET_SPIDERSNEST, BATTLEANIMFUNC_SPIDERS_NEST, PAL_BATTLE_OB_BLUE, ANIM_GFX_WIND_BG ; ANIM_OBJ_SPIDERSNEST
