...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0E, BATTLEANIMFUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_POISON_SHOT
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_STONE_HIT, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS ; ANIM_OBJ_STONE_HIT
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_STONE_HIT, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS ; ANIM_OBJ_STONE_HIT_STILL
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_VOICE_BURST, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_CHARGE ; ANIM_OBJ_VOICE_BURST
