...
endc
	...
	; tm/hm learnset
	tmhm SPIRIT_VOICE, ROAR, TOXIC, HIDDEN_POWER, SUNNY_DAY,  PROTECT, BULLDOZE,  EARTHQUAKE, RETURN, DIG, ROCK_SMASH, DOUBLE_TEAM, FLASH_CANNON, SANDSTORM, SUBSTITUTE, FACADE, REST, ATTRACT, ROCK_SLIDE, DARK_PULSE, DRAGON_PULSE, EXPLOSION, GUNGNIR, STONE_EDGE, GYRO_BALL, CUT, STRENGTH,  DOUBLE_EDGE, EARTH_POWER, ENDURE, HEADBUTT, IRON_HEAD, ROLLOUT, SLEEP_TALK, SWAGGER
	; end
