...
endc
	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, SHADOW_FORCE, TOXIC, HIDDEN_POWER, SUNNY_DAY,  PROTECT, BULLDOZE, FLOWER_SHOOT,  THUNDERBOLT, EARTHQUAKE, RETURN, MANA_BURST, ROCK_SMASH, DOUBLE_TEAM, FLASH_CANNON, FIRE_BREATH, HELLBLAZE, SUBSTITUTE, FACADE, FLAME_CHARGE, REST, ATTRACT, THIEF, ROCK_SLIDE, FOCUS_BLAST, WILL_O_WISP, ULTICHARGE, STRENGTH, BODY_SLAM, COUNTER, DOUBLE_EDGE, ENDURE, FIRE_PUNCH, HEADBUTT, SEISMIC_TOSS, SLEEP_TALK, SWAGGER, THUNDERPUNCH
	; end
