...
endc
	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, POISON_CLAW, CALM_MIND, TOXIC, HAIL,  HIDDEN_POWER, SUNNY_DAY, ICE_BEAM, BLIZZARD,  RAIN_DANCE, SAFEGUARD, BULLDOZE, EARTHQUAKE, RETURN, DIG, MANA_BURST, SHADOW_BALL, ROCK_SMASH, DOUBLE_TEAM, FLAME_SHOOT, SLUDGE_BOMB, HELLBLAZE, SWIFT, AERIAL_ACE, SUBSTITUTE, FACADE, REST, LUSTER_HEART, FOCUS_BLAST, SCALD, DRAIN_PUNCH, WATER_PULSE, POISON_JAB, AVALANCHE, ULTICHARGE, FLASH, THUNDER_WAVE, SURF, STRENGTH, WHIRLPOOL,  BODY_SLAM, COUNTER, DOUBLE_EDGE, DREAM_EATER, ENDURE, HEADBUTT, ICE_PUNCH, ICY_WIND, PAY_DAY, SEISMIC_TOSS, SKILL_SWAP, SLEEP_TALK, SWAGGER, TRICK, TRICK_ROOM, ZAP_CANNON, 
	; end
