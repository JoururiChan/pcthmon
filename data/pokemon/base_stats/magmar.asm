	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, SHADOW_FORCE, TOXIC, HIDDEN_POWER, SUNNY_DAY,  PROTECT,  RETURN, PSYCHIC, ROCK_SMASH, DOUBLE_TEAM, FIRE_BREATH, HELLBLAZE, SUBSTITUTE, FACADE, FLAME_CHARGE, REST, ATTRACT, THIEF, FOCUS_BLAST, WILL_O_WISP, ULTICHARGE, STRENGTH, BODY_SLAM, COUNTER, DOUBLE_EDGE, ENDURE, FIRE_PUNCH, HEADBUTT, SEISMIC_TOSS, SLEEP_TALK, SWAGGER, THUNDERPUNCH
	; end
