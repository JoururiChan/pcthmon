	...
	; tm/hm learnset
	tmhm SPIRIT_VOICE, POWER_TRICK, CALM_MIND, ROAR, TOXIC, BULK_UP, HIDDEN_POWER, PROTECT, SAFEGUARD, THUNDERBOLT, THUNDER, RETURN, DIG, ROCK_SMASH, PSYCHIC, SHADOW_BALL, DOUBLE_TEAM, METEOR_FALL, HELL_TOKAMAK, FLASH_CANNON, SLUDGE_BOMB, SWIFT, AERIAL_ACE, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, STEEL_WING, ENERGY_LIGHT, LEECH_LIFE, WHITE_BIRD, FOCUS_BLAST, DREAM_HEAVEN, DARK_PULSE, WILL_O_WISP, ACROBATICS, EXPLOSION, SHADOW_HIT, U_TURN, GYRO_BALL, CUT, FLY, STRENGTH, SPIDERS_NEST, BATON_PASS, CHARM, COUNTER, DEFENSE_CURL, DREAM_EATER, ENDURE, VOICE_BIND, ICY_WIND, KNOCK_OFF, SLEEP_TALK, SUCKER_PUNCH, SWAGGER, TRICK, LUNAR_BULLET
	; end
