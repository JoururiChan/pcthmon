...
endc
	...
	; tm/hm learnset
	tmhm SHADOW_FORCE, TOXIC, HIDDEN_POWER, SUNNY_DAY,  PROTECT, RAIN_DANCE, GIGA_DRAIN, RETURN, SHADOW_BALL, DOUBLE_TEAM, SLUDGE_BOMB, SWIFT, AERIAL_ACE, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, STEEL_WING, LEECH_LIFE, AURA_WAVE, CRASH_CROSS, DARK_PULSE, ACROBATICS, POISON_JAB, ULTICHARGE, U_TURN, FLY, LEAF_STORM, DOUBLE_EDGE, ENDURE, SLEEP_TALK, SWAGGER, 
	; end
