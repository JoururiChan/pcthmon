...
endc
	...
	; tm/hm learnset
	tmhm SPIRIT_VOICE, TOXIC, HIDDEN_POWER, SUNNY_DAY,  PROTECT, RAIN_DANCE, GIGA_DRAIN, RETURN, SHADOW_BALL, DOUBLE_TEAM, SLUDGE_BOMB, SWIFT, AERIAL_ACE, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, STEEL_WING, LEECH_LIFE, WHITE_BIRD, ICHIGO_CROSS, DARK_PULSE, ACROBATICS, POISON_JAB, GUNGNIR, U_TURN, FLY, SPIDERS_NEST, DOUBLE_EDGE, ENDURE, SLEEP_TALK, SWAGGER, 
	; end
