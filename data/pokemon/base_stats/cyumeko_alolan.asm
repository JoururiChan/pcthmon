	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, POISON_CLAW, TOXIC, HIDDEN_POWER, SUNNY_DAY, GIGA_DRAIN, RETURN, DIG, SHADOW_BALL, ROCK_SMASH, DOUBLE_TEAM, FLAME_SHOOT, SLUDGE_BOMB, HELLBLAZE, SUBSTITUTE, FACADE, REST, LUSTER_HEART, THIEF, ROCK_SLIDE, FOCUS_BLAST, DARK_PULSE, EXPLOSION, POISON_JAB, ULTICHARGE, STONE_HIT, STRENGTH, BODY_SLAM, ENDURE, FIRE_PUNCH, ICE_PUNCH, KNOCK_OFF, SLEEP_TALK, SWAGGER, THUNDERPUNCH
	; end
