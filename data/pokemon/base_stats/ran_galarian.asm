	...
	; tm/hm learnset
	tmhm POISON_CLAW, CALM_MIND, ROAR, TOXIC, HIDDEN_POWER,  LIGHT_SCREEN, PROTECT, SAFEGUARD, RETURN, MANA_BURST, SHADOW_BALL, DOUBLE_TEAM, REFLECT, STAR_CANNON, SWIFT, AERIAL_ACE, SUBSTITUTE, FACADE, REST, STEEL_WING, ENERGY_LIGHT, ULTICHARGE, CHARGE_OUT, FLY, LEAF_STORM, DOUBLE_EDGE, DREAM_EATER, ENDURE, SKILL_SWAP, SLEEP_TALK, SWAGGER, TRICK_ROOM
	; end
