	...
	; tm/hm learnset
	tmhm SHADOW_FORCE, POWER_TRICK, CALM_MIND, TOXIC, HIDDEN_POWER, HONE_TOOLS, PAY_DAY, SUNNY_DAY, LIGHT_SCREEN, PROTECT, SAFEGUARD, GIGA_DRAIN, HELLBLAZE, CRASH_CROSS, SAFEGUARD, SEAL_NEEDLE, THUNDERBOLT, WILL_O_WISP, THUNDER, RETURN, PSYCHIC, SHADOW_BALL, DOUBLE_TEAM, REFLECT, FLASH_CANNON, SWIFT, SUBSTITUTE, FACADE, REST, ATTRACT, ENERGY_LIGHT, FOCUS_BLAST, ENERGY_BALL, GYRO_BALL, FLASH, BATON_PASS, CHARM, DREAM_EATER, EARTH_POWER, VOICE_BIND, SUCKER_PUNCH, DEFENSE_CURL, TREMORS, SKILL_SWAP, SLEEP_TALK, TRICK_ROOM
	; end
