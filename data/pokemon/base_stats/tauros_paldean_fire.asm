	...
	; tm/hm learnset
	tmhm SPIRIT_VOICE, TOXIC, BULK_UP, HIDDEN_POWER, SUNNY_DAY, AEROBLAST, PROTECT, BULLDOZE, FLOWER_SHOOT, BRAVER, EARTHQUAKE, RETURN, ROCK_SMASH, DOUBLE_TEAM, METEOR_FALL, HELL_TOKAMAK, SUBSTITUTE, FACADE, FLAME_CHARGE, REST, ATTRACT, KNIFE_THROW, GUNGNIR, STRENGTH, BODY_SLAM, DOUBLE_EDGE, ENDURE, HEADBUTT, IRON_HEAD, SLEEP_TALK, SWAGGER, 
	; end
