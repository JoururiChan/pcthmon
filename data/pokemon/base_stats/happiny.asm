	...
	; tm/hm learnset
	tmhm TOXIC, HAIL, HIDDEN_POWER, SUNNY_DAY, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SAFEGUARD, FLOWER_SHOOT, RETURN, PSYCHIC, SHADOW_BALL, DOUBLE_TEAM, METEOR_FALL, HELL_TOKAMAK, SUBSTITUTE, FACADE, REST, ATTRACT, DRAIN_PUNCH, WATER_PULSE, FLASH, THUNDER_WAVE, CHARM, COUNTER, DEFENSE_CURL, DREAM_EATER, ENDURE, HEADBUTT, VOICE_BIND, ICY_WIND, ROLLOUT, SEISMIC_TOSS, SLEEP_TALK, SWAGGER, 
	; end
