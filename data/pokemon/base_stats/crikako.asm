	...
	; tm/hm learnset
	tmhm CURSE, ROAR, TOXIC, BULK_UP, VENOSHOCK, HIDDEN_POWER, SUNNY_DAY, HONE_TOOLS, AEROBLAST, PROTECT, GIGA_DRAIN, RETURN, RAIN_DANCE, SAFEGUARD, BULLDOZE, DOUBLE_TEAM, SLUDGE_BOMB, THUNDERBOLT, THUNDER, PSYCHIC_M, ROCK_SMASH, FLASH_CANNON, AERIAL_ACE, METEOR_FALL, SWIFT, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, FLAME_CHARGE, STEEL_WING, ROCK_SLIDE, ACROBATICS, EXPLOSION, FLASH, VOLT_SWITCH, THUNDER_WAVE, CUT, STRENGTH, WHIRLPOOL, BODY_SLAM, COUNTER, DOUBLE_EDGE, DREAM_EATER, ENDURE, KNOCK_OFF, SEED_BOMB, SLEEP_TALK, SWAGGER
	; end
