...
endc
	...
	; tm/hm learnset
	tmhm SPIRIT_VOICE, CALM_MIND, TOXIC, HIDDEN_POWER, SUNNY_DAY, AEROBLAST, LIGHT_SCREEN, PROTECT, BULLDOZE, FLOWER_SHOOT, EARTHQUAKE, RETURN, ROCK_SMASH, DOUBLE_TEAM, REFLECT, METEOR_FALL, SANDSTORM, HELL_TOKAMAK, SUBSTITUTE, FACADE, FLAME_CHARGE, REST, ATTRACT, ROCK_SLIDE, WILL_O_WISP, EXPLOSION, GUNGNIR, STONE_EDGE, GYRO_BALL, STRENGTH, BODY_SLAM, DEFENSE_CURL, DOUBLE_EDGE, EARTH_POWER, ENDURE, ROLLOUT, SLEEP_TALK, SWAGGER
	; end
