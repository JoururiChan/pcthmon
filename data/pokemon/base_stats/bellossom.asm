...
endc
	...
	; tm/hm learnset
	tmhm POISON_CLAW, TOXIC, HIDDEN_POWER, SUNNY_DAY,  PROTECT, GIGA_DRAIN, SAFEGUARD, FLOWER_SHOOT, RETURN, DOUBLE_TEAM, SLUDGE_BOMB, SUBSTITUTE, FACADE, REST, LUSTER_HEART, ENERGY_LIGHT,  DRAIN_PUNCH, ULTICHARGE, FLASH, SWORDS_DANCE, CUT, BATON_PASS, CHARM, DOUBLE_EDGE, EARTH_POWER, ENDURE, VOICE_BIND, SEED_BOMB, SLEEP_TALK, SWAGGER
	; end
