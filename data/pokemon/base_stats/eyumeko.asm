	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HIDDEN_POWER, ROAR, BULK_UP, PROTECT, HONE_TOOLS, TENSION_KICK, RETURN, DIG, EARTHQUAKE, ROCK_SMASH, DOUBLE_TEAM, REFLECT, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, SWIFT, AERIAL_ACE, FOCUS_BLAST, FLAME_CHARGE, ENERGY_LIGHT, BLADE_FLASH, DRAIN_PUNCH, SHADOW_HIT, POISON_JAB, GUNGNIR, STONE_EDGE, SWORDS_DANCE, CUT, STRENGTH, KNIFE_THROW, BATON_PASS, COUNTER, DOUBLE_EDGE, EARTH_POWER, ENDURE, FIRE_PUNCH, HEADBUTT, IRON_HEAD, KNOCK_OFF, STEEL_FIST, ROLLOUT, SEISMIC_TOSS, SLEEP_TALK, SWAGGER, SUCKER_PUNCH, THUNDERPUNCH, TRICK_ROOM
	; end
