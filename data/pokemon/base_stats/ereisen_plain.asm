	...
	; tm/hm learnset
	tmhm CURSE, TOXIC, HIDDEN_POWER, LIGHT_SCREEN, CALM_MIND, PROTECT, RETURN, THUNDERBOLT, DOUBLE_TEAM, SWIFT, PSYCHIC, SHADOW_BALL, REFLECT, SUBSTITUTE, FLASH_CANNON, METEOR_FALL, DIG, FACADE, HELL_TOKAMAK, ENERGY_LIGHT, FOCUS_BLAST, DARK_PULSE, FLASH, THUNDER_WAVE, REST, ATTRACT, WILL_O_WISP, BODY_SLAM, DEFENSE_CURL, DOUBLE_EDGE, ENDURE, HEADBUTT, ROLLOUT, SLEEP_TALK, SWAGGER
	; end
