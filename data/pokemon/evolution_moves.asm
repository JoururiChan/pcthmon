...
endc
	...
	db NO_MOVE      ; CCHEN, GALARIAN_FORM
	db NO_MOVE      ; RAN, GALARIAN_FORM
	db NO_MOVE      ; ERAN, GALARIAN_FORM
	db NO_MOVE      ; CYUKARI, GALARIAN_FORM
	...
	db NO_MOVE      ; CLILYBLACK, PALDEAN_FORM
	db NO_MOVE      ; CLILYBLACK, CLILYBLACK_PALDEAN_FIRE_FORM
	db NO_MOVE      ; CLILYBLACK, CLILYBLACK_PALDEAN_WATER_FORM
