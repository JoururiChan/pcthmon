...
VariantSpeciesAndFormTable:
	...
	dp CSARA,    ALOLAN_FORM
	dp SARA,   ALOLAN_FORM
	dp ESARA,      ALOLAN_FORM
	dp EYUKI,     ALOLAN_FORM
	dp CYUMEKO,        ALOLAN_FORM
	dp ECIRNO,  ALOLAN_FORM
	dp MEILING,    ALOLAN_FORM
	dp ECHIYURI,     GALARIAN_FORM
	dp CLUIZE,     GALARIAN_FORM
	dp LUIZE,   GALARIAN_FORM
	dp ELUIZE,   GALARIAN_FORM
	dp CALICE,    GALARIAN_FORM
	dp CMAI, GALARIAN_FORM
	dp CPATCHOULI,    GALARIAN_FORM
	dp CCHEN,   GALARIAN_FORM
	...
	dp KURUMI,   HISUIAN_FORM
	dp EDAICHAN,    HISUIAN_FORM
	dp CCIRNO,  HISUIAN_FORM
	dp EREISEN, HISUIAN_FORM
	dp QWILFISH,   HISUIAN_FORM
	dp SNEASEL,    HISUIAN_FORM
	dp WOOPER,     PALDEAN_FORM
	dp CLILYBLACK,     PALDEAN_FORM
	dp CLILYBLACK,     CLILYBLACK_PALDEAN_FIRE_FORM
	dp CLILYBLACK,     CLILYBLACK_PALDEAN_WATER_FORM
