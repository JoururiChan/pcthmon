...
MachopEvosAttacks:
	...
	db 27, STEEL_FIST ; Wake-Up Slap → egg move
...
FarfetchDPlainEvosAttacks:
	db -1 ; no more evolutions
	db 1, POISON_JAB
	db 1, BATON_PASS ; Dive Kick → event move
	db 1, PECK
	...
	db 33, NIGHT_SLASH
	db 37, ACROBATICS
	db 43, TENSION_KICK ; Feint → new move
	db 45, BLADE_FLASH
	db 49, AIR_SLASH
	db 55, DIVE_KICK
	db -1 ; no more level-up moves
...
DoduoEvosAttacks:
	...
	db 33, FIVEELEMENTS ; Acupressure → Crystal move
	db 36, SWORDS_DANCE
	db 40, TENSION_KICK ; Jump Kick → similar move
	db 43, DRAGON_DRILL
...
DodrioEvosAttacks:
	...
	db 38, SWORDS_DANCE
	db 43, TENSION_KICK ; Jump Kick → similar move
	db 47, DRAGON_DRILL
...
DrowzeeEvosAttacks:
	...
	db 25, PSYBEAM
	db 29, FIVEELEMENTS ; Wake-Up Slap → RBY TM move
...
KrabbyEvosAttacks:
	...
	db 25, STOMP
	db 29, PROTECT
	db 31, ICHIGO_CROSS ; Guillotine → TM move
...
KinglerEvosAttacks:
	...
	db 25, STOMP
	db 32, PROTECT
	db 37, ICHIGO_CROSS ; Guillotine → TM move
