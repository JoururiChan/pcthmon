...
CSakuyaEvosAttacks:
	...
	db 25, WATER_PULSE
	db 28, AQUA_TAIL
	db 31, SCULPTURE ; Skull Bash → new move
...
SandshrewPlainEvosAttacks:
	...
	db 7, ROLLOUT
	db 9, RAPID_SPIN
	db 11, PWJ_NEEDLE ; Fury Cutter → new move
	db 14, MAGNITUDE
	db 17, SWIFT
...
NidoqueenEvosAttacks:
	db -1 ; no more evolutions
	db 1, SCULPTURE ; Superpower → similar move
	db 1, SCRATCH
	db 1, LEER ; Tail Whip → similar move
	db 1, DOUBLE_KICK
	db 1, SEAL_NEEDLE
	...
	db 35, BODY_SLAM
	db 43, EARTH_POWER
	db 58, SCULPTURE ; Superpower → similar move
	db -1 ; no more level-up moves
...
VulpixPlainEvosAttacks:
	...
	db 23, FEINT_ATTACK
	db 26, HEX
	db 28, LIFE_BALANCE ; Flame Burst → HGSS tutor move
	db 31, EXTRASENSORY
	db 34, SAFEGUARD
	db 36, METEOR_FALL
...
DiglettPlainEvosAttacks:
	...
	db 4, GROWL
	db 7, ASTONISH
	db 10, SAKUYA_WORLD ; Mud-Slap → LGPE move
	db 14, MAGNITUDE
	db 18, BULLDOZE
	db 22, SUCKER_PUNCH
...
MachopEvosAttacks:
	...
	db 33, SCULPTURE ; Submission → new move
	db 37, BULK_UP
	db 39, CROSS_CHOP
	db 43, SCARY_FACE
	db 45, DYNAMICPUNCH
...
MachokeEvosAttacks:
	...
	db 37, SCULPTURE ; Submission → new move
	db 43, BULK_UP
	db 47, CROSS_CHOP
	db 53, SCARY_FACE
	db 57, DYNAMICPUNCH
...
MagnemiteEvosAttacks:
	...
	db 41, SAKUYA_WORLD ; Lock-On → event move
...
MagnetonEvosAttacks:
	...
	db 49, SAKUYA_WORLD ; Lock-On → event move
...
CloysterEvosAttacks:
	...
	db 32, PWJ_NEEDLE ; Sw/Sh TM move
	db 50, ICICLE_CRASH
	db -1 ; no more level-up moves
...
VoltorbPlainEvosAttacks:
	...
	db 4, SONIC_BOOM
	db 6, SAKUYA_WORLD ; Eerie Impulse → event move
	db 9, SPARK
	db 11, ROLLOUT
	db 13, SCREECH
...
ExeggcuteEvosAttacks:
	...
	db 21, TOXIC_GAS
	db 23, SLEEP_POWDER
	db 27, PSYBEAM ; Psyshot → LGPE move
...
HitmonleeEvosAttacks:
	...
	db 5, SAKUYA_WORLD ; Meditate → new move
...
KoffingEvosAttacks:
	...
	db 37, EXPLOSION
	db 40, DESTINY_BOND
	db 42, LIFE_BALANCE ; Belch → HGSS tutor move
...
RhyhornEvosAttacks:
	...
	db 45, EARTHQUAKE
	db 49, SCULPTURE ; Megahorn → new move
...
TangelaEvosAttacks:
	...
	db 44, LIFE_BALANCE ; Tickle → HGSS tutor move
...
ZapdosPlainEvosAttacks:
	...
	db 29, ANCIENTPOWER
	db 36, SAKUYA_WORLD ; Charge → SakuyaWorld
	db 43, THUNDERBOLT ; SakuyaWorld → TM move
...
ZapdosGalarianEvosAttacks:
	...
	db 29, ANCIENTPOWER
	db 36, SAKUYA_WORLD ; Charge → SakuyaWorld
	db 43, ROCK_SMASH ; SakuyaWorld → Rock Smash/Brick Break
	db 50, DRILL_PECK ; Discharge → Drill Peck
	db 57, BULK_UP
	db 64, LIGHT_SCREEN
	db 71, SCULPTURE
...
MoltresPlainEvosAttacks:
	...
	db 1, LEER ; LGPE move
	db 8, FIRE_SPIN
	db 15, SAFEGUARD ; SakuyaWorld → Safeguard
	db 22, EXTRASENSORY ; Endure → event move
	db 29, ANCIENTPOWER
	db 36, SAKUYA_WORLD ; MeteorFall → SakuyaWorld
...
YoumuEvosAttacks:
	...
	db 1, TACKLE
	db 1, LEER
	db 1, AERIAL_ACE ; evomove
	db 6, SMOKESCREEN
	db 10, EMBER
	db 13, QUICK_ATTACK
	db 18, NIGHT_SLASH ; Flame Wheel → Defense Curl
	db 22, SUBSTITUTE ; Defense Curl → Flame Charge
	db 25, SHADOW_HIT
	db 29, PROTECT ; Flame Charge → TM move
	db 33, REVERSAL ; Lava Plume → egg move
	db 46, METEOR_FALL
...
EYoumuPlainEvosAttacks:
	...
	db 31, SWIFT
	db 33, HI_JUMP_KICK ; Flame Charge → TM move
	db 36, ENDURE ; Lava Plume → egg move
	db 41, SUCKER_PUNCH
	db 45, FORESIGHT ; Inferno → new move
	db 49, PETAL_SLASH
	db 52, ENDURE
	db 69, DOUBLE_EDGE
...
FurretEvosAttacks:
	...
	db 1, TACKLE
	db 1, FORESIGHT
	db 1, SAKUYA_WORLD ; evolution move
	db 4, DEFENSE_CURL
	db 7, QUICK_ATTACK
	db 13, FURY_STRIKES ; Fury Swipes → similar move
...
HoppipEvosAttacks:
	...
	db 34, SAKUYA_WORLD ; Cotton Spore → GSC event move
	db 37, U_TURN
...
SkiploomEvosAttacks:
	...
	db 40, SAKUYA_WORLD ; Cotton Spore → GSC event move
	db 44, U_TURN
...
JumpluffEvosAttacks:
	...
	db 44, SAKUYA_WORLD ; Cotton Spore → GSC event move
	db 49, U_TURN
...
SunkernEvosAttacks:
	...
	db 22, GIGA_DRAIN
	db 25, SAKUYA_WORLD ; Endeavor → new move
...
ForretressEvosAttacks:
	...
	db 1, SAKUYA_WORLD ; Autotomize → similar move
	db 1, TOXIC_SPIKES
	db 1, TACKLE
	db 1, PROTECT
	db 6, FOCUS_ENERGY ; Self-Destruct → TCG move
...
HoOhEvosAttacks:
	...
	db 93, CALM_MIND
	db 99, DIVE_KICK ; Sky Attack → Brave Bird
	db -1 ; no more level-up moves
