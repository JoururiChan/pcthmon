...
; entries correspond to trainer classes (see constants/trainer_constants.asm)
	...
	db MUSIC_TOHOMANIAC_ENCOUNTER ; pokemaniac
	db MUSIC_LASS_ENCOUNTER ; cosplayer
	db MUSIC_TOHOMANIAC_ENCOUNTER ; super_nerd
	db MUSIC_LASS_ENCOUNTER ; lass
	db MUSIC_BEAUTY_ENCOUNTER ; beauty
	db MUSIC_TOHOMANIAC_ENCOUNTER ; bug_maniac
	db MUSIC_HIKER_ENCOUNTER ; ruin_maniac
	db MUSIC_HIKER_ENCOUNTER ; firebreather
	db MUSIC_TOHOMANIAC_ENCOUNTER ; juggler
	...
	db MUSIC_TOHOMANIAC_ENCOUNTER ; burglar
	db MUSIC_TOHOMANIAC_ENCOUNTER ; pi
	db MUSIC_TOHOMANIAC_ENCOUNTER ; scientist
