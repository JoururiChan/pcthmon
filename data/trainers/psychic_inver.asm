PsychicInverMons:
	...
	dbp 65, ECIRNO, MALE
		db FIGY_BERRY, DVS_HP_FIRE, NAT_SATK_UP_ATK_DOWN | ABIL_ECIRNO_WATER_VEIL
...
endc
	...
	dbp 65, ECHEN, FEMALE
if DEF(FAITHFUL)
		db WIDE_LENS, FAKE_PERFECT_DVS, NAT_SATK_UP_ATK_DOWN | ABIL_ECHEN_OBLIVIOUS
else
		db WIDE_LENS, FAKE_PERFECT_DVS, NAT_SATK_UP_ATK_DOWN | ABIL_ECHEN_FILTER
endc
