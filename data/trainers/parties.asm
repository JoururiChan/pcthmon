...
CarrieGroup:
	...
	dbp 60, EELLEN
		db CHESTO_BERRY
		db HYPER_VOICE, ENERGY_LIGHT, REST, SWEET_KISS
	db -1 ; end
...
FalknerGroup:
	...
	dbp 73, NOCTOWL
		db TWISTEDSPOON
		db AIR_SLASH, PSYCHIC_M, ERUMIASIS, DREAM_EATER
	dbp 70, GLISCOR
		db SCOPE_LENS
...
endc
	...
	dbp 75, PINSIR, MALE
		...
		db MEGAHORN, SWORDS_DANCE, SCULPTURE, EARTHQUAKE
...
WhitneyGroup:
	...
	dbp 72, EELLEN, FEMALE
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL
		db FOCUS_BLAST, HYPER_VOICE, ENERGY_LIGHT, ICE_BEAM
...
if DEF(FAITHFUL)
	dbp 24, SHINKI, MALE
		...
		db ERUMIASIS, CONFUSE_RAY, DISABLE, SHADOW_BALL
else
	dbp 24, KANA, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
...
endc
		ev_spread 64 SAt, 64 Spe
		db ERUMIASIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
	db -1 ; end
...
endc
	...
	dbp 31, CELLY, MALE
		db ZOOM_LENS, ABIL_CELLY_WATER_ABSORB | NAT_NEUTRAL
		ev_spread 160 Atk
		db ICE_PUNCH, ERUMIASIS, WATERFALL, DYNAMICPUNCH
	db -1 ; end
	...
	dbp 75, CELLY, MALE
		db LEFTOVERS, ABIL_CELLY_WATER_ABSORB | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	dbp 73, DRAGONITE, FEMALE
		...
		db DRAGON_DANCE, DRAGON_CLAW, WATERFALL, GUNGNIR
else
...
WillGroup:
	...
	dbp 48, WYRDEER
		...
		db PSYCHIC_M, SHADOW_BALL, CALM_MIND, ERUMIASIS
	dbp 49, JYNX
		db BRIGHTPOWDER
...
KarenGroup:
	...
	dbp 74, ESHINKI
		db MAGNET
		db ERUMIASIS, THUNDER, SHADOW_BALL, DESTINY_BOND
	dbp 73, HONCHKROW
		db BLACKGLASSES
...
endc
	...
	dbp 76, AERODACTYL, MALE
		...
		db STONE_EDGE, DIVE_KICK, IRON_HEAD, CRUNCH
if DEF(FAITHFUL)
	dbp 75, EMARISA, MALE
...
MistyGroup:
	...
	dbp 72, DAICHAN
		db KINGS_ROCK
		db SWORDS_DANCE, CRABHAMMER, ICHIGO_CROSS, ROCK_SLIDE
	dbp 73, LANTURN
		db NEVERMELTICE
...
LtSurgeGroup:
	...
	dbp 58, JOLTEON
		...
		db BLAZE_STAR, THUNDER_WAVE, SAKUYA_WORLD, THUNDER
	dbp 60, CSARIEL
		db SITRUS_BERRY
		ev_spread 36 Atk, 252 SAt
...
endc
	...
	dbp 74, LEAFEON
		db MIRACLE_SEED, FAKE_PERFECT_DVS
		db SWORDS_DANCE, SEED_BOMB, IRON_TAIL, ICHIGO_CROSS
	dbp 74, KANA
...
JanineGroup:
	...
	dbp 61, ARIADOS
		...
		db SAKUYA_WORLD, POISON_JAB, MEAN_LOOK, PSYCHIC_M
	dbp 62, QWILFISH
		db NO_ITEM
		ev_spread 252 HP, 164 Atk
...
SabrinaGroup:
	...
	dbp 59, GIRAFARIG
		...
		db PSYCHIC_M, CRUNCH, SAKUYA_WORLD, CALM_MIND
	dbp 60, MR__MIME
		db NO_ITEM
		ev_spread 252 HP, 68 Spe
	...
	dbp 59, ERUMIA
		...
		db ERUMIASIS, DREAM_EATER, NASTY_PLOT, PSYCHIC_M
	dbp 58, WOBBUFFET
		db NO_ITEM
		ev_spread 252 HP, 68 Spe
	...
	dbp 72, ERUMIA
		db TWISTEDSPOON
		db NASTY_PLOT, PSYCHIC_M, ERUMIASIS, FUTURE_SIGHT
	dbp 74, SLOWKING
		db KINGS_ROCK
...
BlaineGroup:
	...
	dbp 66, KURUMI
		...
		db CRUNCH, FLAME_CHARGE, LAVATEIN, TAKE_DOWN
	dbp 66, CELLEN
		db NO_ITEM
	...
	dbp 73, KURUMI
		db KINGS_ROCK
		db CRUNCH, FLAME_CHARGE, LAVATEIN, EXTREMESPEED
	dbp 74, FLAREON
		db CHARCOAL
	...
	dbp 75, LUIZE
		db POISON_BARB
		db MEGAHORN, POISON_JAB, LAVATEIN, BLAZE_STAR
	db -1 ; end
...
if DEF(FAITHFUL)
	...
	dbp 88, EMARISA, MALE
		...
		db LAVATEIN, SWORDS_DANCE, EARTHQUAKE, DRAGON_CLAW
endc
	db -1 ; end
...
LeafGroup:
	...
	dbp 98, MOLTRES, FEMALE
		...
		db HELL_TOKAMAK, AIR_SLASH, HIDDEN_POWER, EXTRASENSORY
	...
	dbp 98, AERODACTYL, FEMALE
		...
		db HONE_TOOLS, CRUNCH, EARTHQUAKE, ROCK_SLIDE
if DEF(FAITHFUL)
	dbp 99, MEW, FEMALE
...
Rival1Group:
	...
	dbp 16, CKOTOHIME
		db NO_ITEM
		ev_spread 72 Spe
		db KARATE_CHOP, SWEET_KISS, DISARM_VOICE, MACH_PUNCH ; default for level
	dbp 15, CSARA
		db NO_ITEM
		ev_spread 72 HP
	...
	dbp 19, RUMIA
		db NO_ITEM
		ev_spread 104 Spe
		db ERUMIASIS, PSYSHOT, HEADBUTT, LOW_KICK
	dbp 20, KOTOHIME
		db NO_ITEM
		ev_spread 104 Spe
...
FisherGroup:
	...
	dbp 39, SEAKING
		db WATERFALL, SAKUYA_WORLD, FURY_STRIKES, POISON_JAB
	db -1 ; end
	...
	; party
	dbp 43, CELLY
		db RAIN_DANCE, ERUMIASIS, WATERFALL, SCULPTURE
	dbp 43, SEAKING
		db SAKUYA_WORLD, WATERFALL, BODY_SLAM, POISON_JAB
	dbp 45, QWILFISH
...
PsychicGroup:
	...
	; party
	dbp 17, RUMIA
		db ERUMIASIS, DISABLE, DREAM_EATER, 0
	db -1 ; end
	...
	dbp 20, ELUIZE
		db CURSE, BODY_SLAM, WATER_GUN, PSYSHOT
	db -1 ; end
	...
	dbp 14, ELLY
		db TELEPORT, FLASH, 0, 0
	dbp 16, EELLY
		db TELEPORT, CALM_MIND, PSYSHOT, 0
	db -1 ; end
...
CoupleGroup:
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp LEVEL_FROM_BADGES + 2, EYUMEKO, FEMALE
		db ABILITY_1 | NAT_NEUTRAL
...
endc
	...
	dbp LEVEL_FROM_BADGES + 8, EMARISA, MALE
		...
		ev_spread 132 Atk, 132 Spe
		db DRAGON_DANCE, DRAGON_CLAW, EARTHQUAKE, LAVATEIN
	db -1 ; end
...
GuitaristFGroup:
	...
	dbp 55, CSARIEL, FEMALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
		db EXTREMESPEED, SURF, THUNDERBOLT, SAKUYA_WORLD
	db -1 ; end
...
SightseerFGroup:
	...
	dbp LEVEL_FROM_BADGES + 6, CYUKA, FEMALE
		db FLAME_ORB, FAKE_PERFECT_DVS, ABIL_CYUKA_SYNCHRONIZE | NAT_SATK_UP_ATK_DOWN
		ev_spread 168 SAt
		db LIGHT_SCREEN, REFLECT, PSYCHIC_M, SHADOW_BALL
	dbp LEVEL_FROM_BADGES + 6, CMUGETSU, FEMALE
		db FLAME_ORB, FAKE_PERFECT_DVS, ABIL_CMUGETSU_GUTS | NAT_ATK_UP_SATK_DOWN
		ev_spread 168 Atk
...
CooltrainerMGroup:
	...
	dbp LEVEL_FROM_BADGES + 4, CSARA, MALE
		db AIR_BALLOON, $DD, $DD, $DD, ABIL_CSARA_STURDY | NAT_DEF_UP_SPE_DOWN
		ev_spread 12 HP
	...
	dbp LEVEL_FROM_BADGES + 3, MUGETSU, MALE
		db MIRACLE_SEED, $EE, $EE, $EE, ABIL_MUGETSU_CHLOROPHYLL | NAT_ATK_UP_SATK_DOWN
		ev_spread 20 Atk
...
CooltrainerFGroup:
	...
	; party
	dbp 40, LUIZE
		db STOMP, FIRE_SPIN, PLAY_ROUGH, SAKUYA_WORLD
	dbp 39, FLAAFFY
...
endc
	...
	; party
	dbp 35, FGYOKU
		db SUPERSONIC, PSYBEAM, ERUMIASIS, HEALINGLIGHT
	dbp 36, BELLOSSOM
	...
	dbp LEVEL_FROM_BADGES + 4, EMUGETSU, FEMALE
		db BINDING_BAND, ABIL_EMUGETSU_CHLOROPHYLL | NAT_SPE_UP_DEF_DOWN
		ev_spread 104 HP
...
endc
	dbp 41, CELLEN
		db CHARCOAL
		db METEOR_FALL, SHADOW_BALL, CONFUSE_RAY, EXTRASENSORY
	dbp 39, CGENGETSU
		db MIRACLE_SEED
...
endc
	...
	dbp 60, ZAPDOS
		db WISE_GLASSES
		db THUNDERBOLT, AIR_SLASH, WHITE_BIRD, EXTRASENSORY
	dbp 60, MOLTRES
		db FOCUS_BAND
...
VeteranFGroup:
	...
	dbp LEVEL_FROM_BADGES + 11, CYUKA, FEMALE
		db CHOICE_SPECS, DVS_HP_FIRE, ABIL_CYUKA_TRACE | NAT_SATK_UP_ATK_DOWN
...
PetrelGroup:
	...
	dbp 39, CELIS, MALE | ALOLAN_FORM
		db BLACKGLASSES, ABILITY_1 | NAT_NEUTRAL
		db QUICK_ATTACK, SCREECH, CRUNCH, LIFE_COUNTER
	db -1 ; end
	...
	dbp 35, CELIS, MALE | ALOLAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		ev_spread 108 Atk, 108 Spe
		db SWORDS_DANCE, CRUNCH, LIFE_COUNTER, POWER_BITE
	dbp 36, WEEZING, MALE
...
ArcherGroup:
	...
	dbp 43, CELIS, MALE | ALOLAN_FORM
		db BLACKGLASSES, ABILITY_1 | NAT_NEUTRAL
		db CRUNCH, LIFE_COUNTER, POWER_BITE, DOUBLE_EDGE
	dbp 41, ESHINKI, MALE
		db SPELL_TAG, ABILITY_1 | NAT_NEUTRAL
		db ERUMIASIS, CONFUSE_RAY, LIFE_BALANCE, SHADOW_BALL
	dbp 42, WEEZING, MALE
		db BRIGHTPOWDER, ABILITY_1 | NAT_NEUTRAL
	...
	dbp 30, CELIS, MALE | ALOLAN_FORM
		...
		db PURSUIT, POWER_BITE, SCARY_FACE, CRUNCH
	dbp 28, WEEZING, MALE
		db SILK_SCARF, ABILITY_1 | NAT_NEUTRAL
		ev_spread 88 Atk, 88 Spe
...
endc
		db LAVATEIN, DRAGON_CLAW, CRUNCH, DRAGON_DANCE
	dbp 80, ESAKUYA, MALE
...
AgathaGroup:
	...
	dbp 62, CROBAT, FEMALE
		...
		db AIR_SLASH, CRUNCH, ICHIGO_CROSS, POISON_JAB
...
ValerieGroup:
	...
	dbp 56, AZUMARILL, FEMALE
		db MUSCLE_BAND, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 Atk, 68 Spe
		db PLAY_ROUGH, WATERFALL, DIZZY_PUNCH, SCULPTURE
	dbp 56, LUIZE, FEMALE | GALARIAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 Atk, 68 Spe
		db METEOR_FALL, ZEN_HEADBUTT, PLAY_ROUGH, SWORDS_DANCE
	...
	dbp 72, LUIZE, FEMALE | GALARIAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		db HELL_TOKAMAK, ZEN_HEADBUTT, PLAY_ROUGH, BLAZE_STAR
...
YellowGroup:
	...
	dbp LEVEL_FROM_BADGES + 5, SARA, FEMALE
		db EVIOLITE, ABIL_SARA_STURDY | NAT_ATK_UP_SATK_DOWN, "Gravvy@"
		ev_spread 240 HP
	...
	dbp 73, CELIS, FEMALE
		...
		db SWORDS_DANCE, QUICK_ATTACK, LIFE_COUNTER, CRUNCH
	...
	dbp 73, ESARA, FEMALE
		db MUSCLE_BAND, ABIL_ESARA_STURDY | NAT_ATK_UP_SATK_DOWN, "Gravvy@"
...
if DEF(FAITHFUL)
		...
		db SWORDS_DANCE, HELL_TOKAMAK, ROCK_SLIDE, DRAGON_CLAW
endc
	dbp 72, XATU
		db QUICK_CLAW
...
if DEF(FAITHFUL)
		...
		db SWORDS_DANCE, LAVATEIN, SLASH, DRAGON_CLAW
endc
...
ReiGroup:
	...
	dbp 57, NOCTOWL
		db QUICK_CLAW
		ev_spread 68 SAt, 252 Spe
		db SHADOW_BALL, AIR_SLASH, ERUMIASIS, DREAM_EATER
	dbp 57, CYUKA
		db WISE_GLASSES
		ev_spread 68 SAt, 252 Spe
	...
	dbp 58, LUIZE
		db KINGS_ROCK
		ev_spread 68 HP, 252 Spe
		db HELL_TOKAMAK, MEGAHORN, POISON_JAB, WILL_O_WISP
	dbp 60, CELLEN
		db LEFTOVERS
		ev_spread 68 SAt, 252 Spe
	...
	dbp 73, LUIZE
		db KINGS_ROCK
		db LAVATEIN, MEGAHORN, POISON_JAB, WILL_O_WISP
	dbp 75, CELLEN
		db LEFTOVERS
