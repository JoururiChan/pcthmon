...
endc
	...
	dbp 74, SCIRNO, FEMALE
		db LUM_BERRY, ABIL_SCIRNO_WATER_VEIL | NAT_NEUTRAL
...
endc
	...
	dbp 75, ELILYBLACK, MALE
		...
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	dbp 77, SCIRNO, MALE
		db LUM_BERRY, ABIL_SCIRNO_WATER_VEIL | NAT_SATK_UP_ATK_DOWN
...
LeafGroup:
	...
	dbp 98, CYUKARI, FEMALE
		db CHARCOAL, DVS_HP_NATURE, ABIL_CYUKARI_FLAME_BODY | NAT_SATK_UP_ATK_DOWN
...
VeteranFGroup:
	...
	dbp LEVEL_FROM_BADGES + 11, CLUNASA_Z, FEMALE
		db CHOICE_SPECS, DVS_HP_NATURE, ABIL_CLUNASA_Z_ADAPTABILITY | NAT_SATK_UP_ATK_DOWN
		ev_spread 252 SAt, 44 Spe
