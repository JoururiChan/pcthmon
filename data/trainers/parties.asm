...
MortyGroup:
	...
	dbp 71, MEILING, MALE
		...
		db BONEMTRANG, STONE_EDGE, ICE_PUNCH, SHADOW_HIT
...
endc
	...
	dbp 74, SCIRNO, FEMALE
		db LUM_BERRY, ABIL_SCIRNO_HARVEST | NAT_NEUTRAL
...
ChampionGroup:
	...
	dbp 57, AYUYUKO, MALE
		db KINGS_ROCK, ABIL_AYUYUKO_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		ev_spread 164 Atk, 252 Spe
...
endc
	...
	dbp 75, ELILYBLACK, MALE
		...
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	dbp 77, SCIRNO, MALE
		db LUM_BERRY, ABIL_SCIRNO_HARVEST | NAT_SATK_UP_ATK_DOWN
	...
	dbp 76, AYUYUKO, MALE
		db CHOICE_BAND, ABIL_AYUYUKO_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
...
RedGroup:
	...
	dbp 87, ALUNASA, MALE
		db WISE_GLASSES, ABIL_ALUNASA_SHELL_ARMOR | NAT_SATK_UP_ATK_DOWN
...
LeafGroup:
	...
	dbp 98, AYUYUKO, FEMALE
		db MUSCLE_BAND, FAKE_PERFECT_DVS, ABIL_AYUYUKO_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db HONE_TOOLS, AVARICE_BITE, EARTHQUAKE, ROCK_SLIDE
if DEF(FAITHFUL)
	dbp 99, TSUIKA, FEMALE
		db WISE_GLASSES, FAKE_PERFECT_DVS, ABIL_TSUIKA_SYNCHRONIZE | NAT_SATK_UP_ATK_DOWN
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ICE_BEAM
else
	dbp 99, TSUIKA, FEMALE
		db WISE_GLASSES, FAKE_PERFECT_DVS, ABIL_TSUIKA_MAGIC_GUARD | NAT_SATK_UP_ATK_DOWN
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ICE_BEAM
endc
	db -1 ; end
...
CowgirlGroup:
	...
	dbp LEVEL_FROM_BADGES + 8, CLILYBLACK, CLILYBLACK_FORM
	dbp LEVEL_FROM_BADGES + 9, CLILYBLACK, CLILYBLACK_FORM
	db -1 ; end
...
EngineerGroup:
	...
	dbp LEVEL_FROM_BADGES + 2, CSARA, MALE
		db ABIL_CSARA_GALVANIZE | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	...
	dbp 61, MEILING, FEMALE
		...
		db SWORDS_DANCE, BONEMTRANG, FIRE_PUNCH, SHADOW_HIT
endc
...
if DEF(FAITHFUL)
	...
	dbp 72, MEILING, FEMALE
		db THICK_CLUB, ABILITY_1 | NAT_NEUTRAL
		db SWORDS_DANCE, BONEMTRANG, ROCK_SMASH, SHADOW_HIT
endc
...
YellowGroup:
	...
	dbp 72, ALUNASA, FEMALE
		db WISE_GLASSES, ABIL_ALUNASA_SHELL_ARMOR | NAT_NEUTRAL, "Omny@"
