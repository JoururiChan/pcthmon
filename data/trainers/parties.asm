...
CarrieGroup:
	...
	dbp 60, EREISEN
		db QUICK_CLAW
		db SUNNY_DAY, THUNDERPUNCH, METEOR_FALL, SUBSTITUTE
	dbp 60, ESANAE
		db LUM_BERRY
		db SURF, AVARICE_BITE, ICE_PUNCH, ROCK_SLIDE
	dbp 60, SKARMORY
		db ROCKY_HELMET
		db SPIKES, WHITE_BIRD, DRAGON_DRILL, STEEL_WING
	dbp 60, HOUNDOOM
		db POISON_BARB
		db NASTY_PLOT, HELL_TOKAMAK, DARK_PULSE, SLUDGE_BOMB
	dbp 60, EELLEN
		db CHESTO_BERRY
...
JackyGroup:
	...
	dbp 60, TOGETIC
		db WIDE_LENS
		db ENERGY_LIGHT, METRONOME, ANCIENTPOWER, LUNACY_EYES
	db -1 ; end
...
FalknerGroup:
	...
	dbp 13, CRIKAKO
		db PECHA_BERRY
		ev_spread 32 HP
		db SUPERSONIC, PSYSHOT, AERIAL_ACE, SKILL_SWAP
	db -1 ; end
	...
	dbp 70, GLISCOR
		db SCOPE_LENS
		db SWORDS_DANCE, EARTHQUAKE, ICHIGO_CROSS, NIGHT_SLASH
	dbp 72, EMAI
		db SILK_SCARF
	...
	dbp 75, MIMA
		db SHARP_BEAK
		db HURRICANE, MASTER_SPARK, STEEL_WING, WHITE_BIRD
	db -1 ; end
...
BugsyGroup:
	...
	dbp 73, HERACROSS, MALE
		...
		db DRAGON_BASH, CROSS_CHOP, ROCK_SMASH, STONE_EDGE
...
endc
	dbp 72, CRIKAKO, MALE
		...
		db SPORE, HEALINGLIGHT, SEED_BOMB, ICHIGO_CROSS
	dbp 75, ELILYWHITE, MALE
		db SCOPE_LENS, ABILITY_1 | NAT_NEUTRAL
		db DRAGON_BASH, SWORDS_DANCE, SCULPTURE, EARTHQUAKE
	dbp 75, CHEN, FEMALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
		db SWORDS_DANCE, NIGHT_SLASH, ICHIGO_CROSS, AERIAL_ACE
	db -1 ; end
...
WhitneyGroup:
	...
	dbp 20, ORANGE, FEMALE
		...
		db LUNAR_BULLET, ROCK_THROW, ATTRACT, BULK_UP
	...
	dbp 71, STANTLER, FEMALE
		...
		db REFLECT, LIGHT_SCREEN, DOUBLE_EDGE, LUNAR_BASH
	dbp 72, MEIRA, FEMALE
...
MortyGroup:
	...
	dbp 70, CELLEN, MALE
		...
		db NASTY_PLOT, SHADOW_BALL, METEOR_FALL, WILL_O_WISP
	dbp 71, MEILING, MALE | ALOLAN_FORM
		db THICK_CLUB, ABILITY_1 | NAT_NEUTRAL
		db BONEMERANG, STONE_EDGE, ICE_PUNCH, SHADOW_HIT
...
ChuckGroup:
	...
	dbp 73, SIRFETCH_D, MALE
		...
		db SCULPTURE, DIVE_KICK, NIGHT_SLASH, POISON_JAB
	dbp 72, CKOAKUMA, MALE
		db NEVERMELTICE, ABIL_CKOAKUMA_SYNCHRONIZE | NAT_NEUTRAL
		db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	dbp 72, EMEILING, MALE
		db QUICK_CLAW, ABIL_EMEILING_IRON_FIST | NAT_NEUTRAL
		db SUCKER_PUNCH, BULK_UP, REVERSAL, TENSION_KICK
	dbp 72, HITMONTOP, MALE
		db KINGS_ROCK, ABIL_HITMONTOP_INTIMIDATE | NAT_NEUTRAL
		db RAPID_SPIN, TOXIC, SCULPTURE, SUCKER_PUNCH
	dbp 75, CELLY, MALE
...
JasmineGroup:
	...
	dbp 34, SKARMORY
		db NO_ITEM
		ev_spread 192 HP
		db MUD_SLAP, DRAGON_DRILL, SPIKES, STEEL_WING
	dbp 33, EALICE
		db NO_ITEM
		ev_spread 192 HP
...
if DEF(FAITHFUL)
	...
	dbp 72, RHYPERIOR
		...
		db EARTHQUAKE, STONE_EDGE, DRAGON_BASH, IRON_HEAD
endc
	dbp 73, SCIZOR
...
ClairGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 43, ELILYBLACK, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 4 Atk, 252 Spe
		db AVARICE_BITE, THRASH, DRAGON_PULSE, AQUA_TAIL
...
endc
if DEF(FAITHFUL)
	dbp 44, EYUKARI, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 128 HP, 128 Spe
		db THUNDER_WAVE, AQUA_TAIL, METEOR_FALL, DRAGON_PULSE
else
...
endc
	...
	dbp 47, KINGDRA, FEMALE
		...
		db SMOKESCREEN, MASTER_SPARK, DRAGON_PULSE, SURF
	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 72, ELILYBLACK, FEMALE
		db BRIGHTPOWDER, ABILITY_1 | NAT_NEUTRAL
		db DRAGON_DANCE, WATERFALL, FLY, EARTHQUAKE
	dbp 74, ECIRNO, FEMALE | ALOLAN_FORM
		db LUM_BERRY, ABIL_ECIRNO_ALOLAN_HARVEST | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	dbp 73, CSUIKA, FEMALE
		...
		db DRAGON_DANCE, SPIRIT_VOICE, WATERFALL, GUNGNIR
else
	dbp 73, AMPHAROS, FEMALE
		db DRAGON_FANG, ABILITY_1 | NAT_NEUTRAL
		db THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
	dbp 74, EYUKARI, FEMALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
...
WillGroup:
	...
	dbp 67, WYRDEER
		...
		db SHADOW_BALL, DRAGON_BASH, EARTHQUAKE, PSYCHIC_M
	dbp 68, ECHEN
...
KogaGroup:
	...
	dbp 50, CLODSIRE
		...
		db POISON_JAB, POISON_NAIL, EARTHQUAKE, DRAGON_BASH
	dbp 52, FORRETRESS
		db SILK_SCARF
	...
	dbp 53, CROBAT
		...
		db DOUBLE_TEAM, POISON_JAB, LIFE_COUNTER, TOXIC
	db -1 ; end
	...
	dbp 70, CYUMEKO, MALE
		db BRIGHTPOWDER, ABILITY_1 | NAT_NEUTRAL
		db MINIMIZE, HELL_TOKAMAK, GUNK_SHOT, TOXIC
...
BrunoGroup:
	...
	dbp 51, HITMONTOP
		...
		db PURSUIT, SCULPTURE, DIG, PROTECT
	dbp 53, SNEASLER
		db SILVERPOWDER
		ev_spread 176 Atk, 176 Spe
		db SWORDS_DANCE, ICHIGO_CROSS, SCULPTURE, GUNK_SHOT
	dbp 51, EMEILING
		db FOCUS_BAND
		ev_spread 176 Atk, 176 Spe
		db SUCKER_PUNCH, DOUBLE_KICK, TENSION_KICK, FORESIGHT
	dbp 51, CKOAKUMA
		db NEVERMELTICE
		ev_spread 176 Atk, 176 Spe
	...
	dbp 70, HITMONTOP
		db QUICK_CLAW
		db BULK_UP, SUCKER_PUNCH, COUNTER, TENSION_KICK
	dbp 71, SNEASLER
		db SILVERPOWDER
		db SWORDS_DANCE, ICHIGO_CROSS, SCULPTURE, GUNK_SHOT
	dbp 70, EMEILING
		db FOCUS_BAND
		db BULK_UP, SUCKER_PUNCH, TENSION_KICK, REVERSAL
	dbp 70, CKOAKUMA
		db NEVERMELTICE
		db THUNDERPUNCH, ICE_PUNCH, POISON_JAB, MACH_PUNCH
	dbp 72, STEELIX
...
KarenGroup:
	...
	dbp 53, CYUMEMI, FEMALE | ALOLAN_FORM
		db PINK_BOW, ABILITY_1 | NAT_NEUTRAL
	...
	dbp 57, HOUNDOOM, FEMALE
		...
		db ROAR, PURSUIT, METEOR_FALL, DARK_PULSE
	db -1 ; end
	...
	dbp 74, TYRANITAR
		db SOFT_SAND
		db EARTHQUAKE, AVARICE_BITE, STONE_EDGE, PURSUIT
	dbp 76, HOUNDOOM
		db WISE_GLASSES
		db ROAR, NASTY_PLOT, HELL_TOKAMAK, DARK_PULSE
	db -1 ; end
...
ChampionGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 57, ELILYBLACK, MALE
		db MUSCLE_BAND, ABIL_ELILYBLACK_INTIMIDATE | NAT_SPE_UP_SATK_DOWN
		ev_spread 164 Atk, 252 Spe
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	dbp 58, CSUIKA, MALE
		db WIDE_LENS, ABIL_CSUIKA_INNER_FOCUS | NAT_SATK_UP_ATK_DOWN
		ev_spread 164 SAt, 252 Spe
		db HELL_TOKAMAK, BLIZZARD, THUNDER, MASTER_SPARK
	dbp 58, KINGDRA, MALE
		db SCOPE_LENS, ABIL_KINGDRA_SNIPER | NAT_SATK_UP_ATK_DOWN
		ev_spread 164 SAt, 252 Spe
		db FOCUS_ENERGY, DRAGON_PULSE, SURF, MASTER_SPARK
	dbp 57, EYUYUKO, MALE
		db KINGS_ROCK, ABIL_EYUYUKO_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		ev_spread 164 Atk, 252 Spe
		db AERIAL_ACE, ANCIENTPOWER, ROCK_SLIDE, GUNGNIR
	dbp 57, EMARISA, MALE
		db WISE_GLASSES, ABIL_EMARISA_SPEED_BOOST | NAT_SATK_UP_ATK_DOWN
		ev_spread 164 SAt, 252 Spe
if DEF(FAITHFUL)
		db METEOR_FALL, MASTER_SPARK, FOCUS_BLAST, AIR_SLASH
else
		db METEOR_FALL, MASTER_SPARK, FOCUS_BLAST, DRAGON_PULSE
endc
	dbp 60, CSUIKA, MALE
		db LEFTOVERS, SHINY_MASK | ABIL_CSUIKA_MULTISCALE | NAT_ATK_UP_SATK_DOWN
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 75, ELILYBLACK, MALE
		db LIFE_ORB, ABILITY_1 | NAT_SPE_UP_SATK_DOWN
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	dbp 77, ECIRNO, MALE | ALOLAN_FORM
		db LUM_BERRY, ABIL_ECIRNO_ALOLAN_HARVEST | NAT_SATK_UP_ATK_DOWN
	...
	dbp 76, EYUYUKO, MALE
		db CHOICE_BAND, ABIL_EYUYUKO_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db STONE_EDGE, DIVE_KICK, IRON_HEAD, AVARICE_BITE
if DEF(FAITHFUL)
	dbp 75, EMARISA, MALE
		db LEFTOVERS, ABIL_EMARISA_DROUGHT | NAT_SATK_UP_ATK_DOWN
		db HELL_TOKAMAK, FLOWER_SHOOT, FOCUS_BLAST, AIR_SLASH
else
	dbp 75, EMARISA, MALE
		db LEFTOVERS, ABIL_EMARISA_BLAZE | NAT_ATK_UP_SATK_DOWN
		db DRAGON_DANCE, OUTRAGE, LAVATEIN, WHITE_BIRD
endc
	dbp 80, CSUIKA, MALE
		db WEAK_POLICY, SHINY_MASK | ABIL_CSUIKA_MULTISCALE | NAT_ATK_UP_SATK_DOWN
...
BrockGroup:
	...
	dbp 65, EYUYUKO
		...
		db AERIAL_ACE, SUPERSONIC, ANCIENTPOWER, MASTER_SPARK
	db -1 ; end
	...
	dbp 73, RHYPERIOR
		db KINGS_ROCK
		db AVALANCHE, ROCK_SLIDE, EARTHQUAKE, DRAGON_BASH
	dbp 72, ELUNASA
		db MYSTIC_WATER
	...
	dbp 73, EYUYUKO
		db QUICK_CLAW
		db STONE_EDGE, EARTHQUAKE, AERIAL_ACE, AVARICE_BITE
	dbp 75, ESARA
		db LEFTOVERS
...
MistyGroup:
	...
	dbp 60, DAICHAN
		...
		db DEFENSE_CURL, STOMP, PROTECT, BUG_STRIKES
	dbp 62, LANTURN
		db NO_ITEM
	...
	dbp 72, DAICHAN
		db KINGS_ROCK
		db SWORDS_DANCE, BUG_STRIKES, ICHIGO_CROSS, ROCK_SLIDE
	dbp 73, LANTURN
		db NEVERMELTICE
		db SURF, THUNDERBOLT, ICE_BEAM, CONFUSE_RAY
	dbp 74, OCTILLERY
		db CHARCOAL
		db HELL_TOKAMAK, ICE_BEAM, HYDRO_PUMP, POWER_WHIP
	dbp 75, ELETTY
		db LEFTOVERS
...
LtSurgeGroup:
	...
	dbp 58, CLILYWHITE
		...
		db QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, BLAZE_STAR
	dbp 56, CCIRNO
		db NO_ITEM
	...
	dbp 57, MAGNEZONE
		db NO_ITEM
		ev_spread 36 HP, 252 SAt
		db LIGHT_SCREEN, DOUBLE_TEAM, BLAZE_STAR, ZAP_CANNON
	dbp 56, CCIRNO
		db NO_ITEM
		ev_spread 36 HP, 252 Atk
		db SCREECH, DOUBLE_TEAM, BLAZE_STAR, EXPLOSION
	dbp 58, MERLIN
		db NO_ITEM
		ev_spread 36 Atk, 252 SAt
		db BLAZE_STAR, THUNDER_WAVE, SPIDERS_NEST, THUNDER
	dbp 60, CSARIEL
		db SITRUS_BERRY
		ev_spread 36 Atk, 252 SAt
		db THUNDER_WAVE, QUICK_ATTACK, BLAZE_STAR, THUNDER
	db -1 ; end
	...
	dbp 74, ELECTIVIRE
		...
		db CROSS_CHOP, THUNDERPUNCH, LIGHT_SCREEN, BLAZE_STAR
	dbp 72, CCIRNO
...
if DEF(FAITHFUL)
		...
		db SUNNY_DAY, HEALINGLIGHT, GIGA_DRAIN, METEOR_FALL
endc
	dbp 62, REMILIA
		db EVIOLITE
...
if DEF(FAITHFUL)
		...
		db SUNNY_DAY, LEECH_SEED, GIGA_DRAIN, HELL_TOKAMAK
endc
	dbp 73, TANGROWTH
		db LEFTOVERS, FAKE_PERFECT_DVS
	...
	dbp 74, LEAFEON
		db MIRACLE_SEED, FAKE_PERFECT_DVS
		db SWORDS_DANCE, SEED_BOMB, BRAVER, ICHIGO_CROSS
	dbp 74, KANA
		db QUICK_CLAW, FAKE_PERFECT_DVS
		db PETAL_SLASH, HEALINGLIGHT, LEECH_SEED, TOXIC
	dbp 75, BELLOSSOM
		db PINK_BOW, DVS_HP_ROCK
		db SLEEP_POWDER, MOONBLAST, PETAL_SLASH, HIDDEN_POWER
	db -1 ; end
...
JanineGroup:
	...
	dbp 61, ARIADOS
		...
		db SPIDERS_NEST, POISON_JAB, MEAN_LOOK, PSYCHIC_M
	dbp 62, QWILFISH
		db NO_ITEM
		ev_spread 252 HP, 164 Atk
	...
	dbp 63, CPATCHOULI
		...
		db SLUDGE_BOMB, THUNDER, HELL_TOKAMAK, EXPLOSION
	dbp 66, ERIKAKO
		db SITRUS_BERRY
		ev_spread 208 SAt, 208 Spe
	...
	dbp 73, CPATCHOULI
		db CHARCOAL
		db SLUDGE_BOMB, HELL_TOKAMAK, WILL_O_WISP, EXPLOSION
	dbp 75, ERIKAKO
		db BRIGHTPOWDER
...
SabrinaGroup:
	...
	dbp 59, GIRAFARIG
		...
		db PSYCHIC_M, AVARICE_BITE, SPIDERS_NEST, CALM_MIND
	dbp 60, CCHEN
		db NO_ITEM
		ev_spread 252 HP, 68 Spe
	...
	dbp 73, CCHEN
		db NO_ITEM
		db PSYCHIC_M, ENERGY_LIGHT, NASTY_PLOT, ENCORE
	dbp 73, FARIGIRAF
		db BRIGHTPOWDER
		db NASTY_PLOT, SHADOW_BALL, VOICE_BIND, PSYCHIC_M
	dbp 72, ERUMIA
		db TWISTEDSPOON
...
BlaineGroup:
	...
	dbp 65, MAGCARGO
		...
		db CURSE, WILL_O_WISP, METEOR_FALL, ROCK_SLIDE
	dbp 68, LILYWHITE
		db EVIOLITE
		ev_spread 252 HP, 228 Def
		db SUNNY_DAY, THUNDERPUNCH, METEOR_FALL, FOCUS_BLAST
	dbp 66, KURUMI
		db NO_ITEM
		ev_spread 252 Atk, 228 Spe
		db AVARICE_BITE, FLAME_CHARGE, LAVATEIN, TAKE_DOWN
	dbp 66, CELLEN
		db NO_ITEM
		ev_spread 252 HP, 228 SAt
		db CONFUSE_RAY, FIRE_SPIN, METEOR_FALL, WILL_O_WISP
	dbp 65, EMERLIN
		db NO_ITEM
		ev_spread 252 Atk, 228 SAt
		db WILL_O_WISP, LAVATEIN, QUICK_ATTACK, HELL_TOKAMAK
	dbp 69, LUIZE
		db SITRUS_BERRY
		ev_spread 252 Atk, 228 Spe
		db QUICK_ATTACK, FIRE_SPIN, PLAY_ROUGH, HELL_TOKAMAK
	db -1 ; end
	...
	dbp 72, MAGMORTAR
		db BLACK_BELT
		db SUNNY_DAY, FOCUS_BLAST, HELL_TOKAMAK, FLASH_CANNON
	dbp 73, KURUMI
		db KINGS_ROCK
		db AVARICE_BITE, FLAME_CHARGE, LAVATEIN, EXTREMESPEED
	dbp 74, EMERLIN
		db CHARCOAL
		db WILL_O_WISP, LAVATEIN, DOUBLE_EDGE, SCARY_FACE
	dbp 72, EREISEN
		db LEFTOVERS
		db HELL_TOKAMAK, FOCUS_BLAST, EARTH_POWER, HIDDEN_POWER
	dbp 75, LUIZE
		db POISON_BARB
		db DRAGON_BASH, POISON_JAB, LAVATEIN, BLAZE_STAR
	db -1 ; end
...
BlueGroup:
	...
	dbp 68, KURUMI
		db CHARCOAL
		db ROAR, FLAME_CHARGE, METEOR_FALL, EXTREMESPEED
	dbp 70, ESAKUYA
		db MYSTIC_WATER
if DEF(FAITHFUL)
...
endc
	...
	dbp 74, KURUMI
		db CHARCOAL
		db ROAR, OUTRAGE, LAVATEIN, EXTREMESPEED
	dbp 75, ESAKUYA
		db LEFTOVERS
...
RedGroup:
	...
	dbp 90, EKIKURI, MALE | EKIKURI_RED_FORM
		...
		db THUNDERBOLT, SURF, BRAVER, BLAZE_STAR
	dbp 84, ESPEON, MALE
		db TWISTEDSPOON, ABIL_ESPEON_MAGIC_BOUNCE | NAT_SATK_UP_ATK_DOWN
		db PSYCHIC_M, HEALINGLIGHT, REFLECT, SHADOW_BALL
	dbp 85, CRAN, MALE
		db LEFTOVERS, ABIL_CRAN_IMMUNITY | NAT_ATK_UP_SATK_DOWN
		db CURSE, REST, SLEEP_TALK, RETURN
	dbp 87, ELUNASA, MALE
		db WISE_GLASSES, ABIL_ELUNASA_SHELL_ARMOR | NAT_SATK_UP_ATK_DOWN
		db SURF, ANCIENTPOWER, EARTH_POWER, ICE_BEAM
	dbp 87, ELILYBLACK, MALE
		db QUICK_CLAW, SHINY_MASK | ABIL_ELILYBLACK_MOXIE | NAT_ATK_UP_SATK_DOWN
		db DRAGON_DANCE, WATERFALL, EARTHQUAKE, AVARICE_BITE
if DEF(FAITHFUL)
	dbp 88, EMARISA, MALE
		db MUSCLE_BAND, ABIL_EMARISA_DROUGHT | NAT_ATK_UP_SATK_DOWN
		db LAVATEIN, SWORDS_DANCE, EARTHQUAKE, AERIAL_ACE
else
	dbp 88, EMARISA, MALE
		db MUSCLE_BAND, ABIL_EMARISA_BLAZE | NAT_ATK_UP_SATK_DOWN
		db LAVATEIN, SWORDS_DANCE, EARTHQUAKE, SPIRIT_VOICE
endc
	db -1 ; end
...
LeafGroup:
	...
	dbp 96, CLYRICA, FEMALE
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_CLYRICA_SHELL_ARMOR | NAT_SATK_UP_ATK_DOWN
		db ICE_BEAM, THUNDERBOLT, REST, SLEEP_TALK
	dbp 100, EREIMU, FEMALE
		db MIRACLE_SEED, FAKE_PERFECT_DVS, ABIL_EREIMU_HAKUREI_MIKO | NAT_SPE_UP_DEF_DOWN
		db GROWTH, GIGA_DRAIN, SLUDGE_BOMB, SLEEP_POWDER
	dbp 98, CYUKARI, FEMALE
		db CHARCOAL, DVS_HP_GRASS, ABIL_CYUKARI_FLAME_BODY | NAT_SATK_UP_ATK_DOWN
		db HELL_TOKAMAK, AIR_SLASH, HIDDEN_POWER, LUNACY_EYES
	...
	dbp 98, EYUYUKO, FEMALE
		db MUSCLE_BAND, FAKE_PERFECT_DVS, ABIL_EYUYUKO_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db HONE_TOOLS, AVARICE_BITE, EARTHQUAKE, ROCK_SLIDE
if DEF(FAITHFUL)
	dbp 99, ESUIKA, FEMALE
		db WISE_GLASSES, FAKE_PERFECT_DVS, ABIL_ESUIKA_SYNCHRONIZE | NAT_SATK_UP_ATK_DOWN
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ICE_BEAM
else
	dbp 99, ESUIKA, FEMALE
		db WISE_GLASSES, FAKE_PERFECT_DVS, ABIL_ESUIKA_MAGIC_GUARD | NAT_SATK_UP_ATK_DOWN
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ICE_BEAM
endc
	db -1 ; end
...
Rival1Group:
	...
	dbp 39, EALICE
		...
		db FIVEELEMENTS, THUNDERBOLT, FLASH_CANNON, THUNDER_WAVE
	dbp 39, SHINKI
		db NO_ITEM
		ev_spread 232 Spe
	...
	dbp 43, EYOUMU
		...
		db REFLECT, LIGHT_SCREEN, PETAL_SLASH, ANCIENTPOWER
	db -1 ; end
	...
	dbp 45, WEAVILE
		db KINGS_ROCK
		db SWORDS_DANCE, SCREECH, NIGHT_SLASH, ICHIGO_CROSS
	dbp 47, KOTOHIME
		db EVIOLITE
		db POISON_JAB, LIFE_COUNTER, CONFUSE_RAY, WING_ATTACK
	dbp 46, EALICE
		db MAGNET
		db THUNDERBOLT, FIVEELEMENTS, THUNDER_WAVE, FLASH_CANNON
	dbp 46, ESHINKI
		db SPELL_TAG
	...
	dbp 49, EYOUMU
		db SITRUS_BERRY
		db REFLECT, LIGHT_SCREEN, DREAM_HEAVEN, ANCIENTPOWER
	db -1 ; end
	...
	dbp 49, EREISEN
		db SITRUS_BERRY
		db SMOKESCREEN, QUICK_ATTACK, DIG, METEOR_FALL
	db -1 ; end
...
Rival2Group:
	...
	dbp 62, KOTOHIME
		...
		db POISON_JAB, LIFE_COUNTER, CONFUSE_RAY, AERIAL_ACE
	dbp 61, MAGNEZONE
		db MAGNET
		ev_spread 252 SAt, 204 Spe
		db FIVEELEMENTS, ZAP_CANNON, THUNDER_WAVE, FLASH_CANNON
	dbp 63, ESHINKI
		db SPELL_TAG
		ev_spread 252 SAt, 204 Spe
	...
	dbp 65, EYOUMU
		db MIRACLE_SEED
		ev_spread 252 Atk, 204 Spe
		db SEED_BOMB, TOXIC_GAS, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	dbp 65, EREISEN
		...
		db METEOR_FALL, EARTH_POWER, THUNDERPUNCH, SMOKESCREEN
	db -1 ; end
	...
	dbp 70, CYUKA
		db BRIGHTPOWDER
		db RECOVER, FIVEELEMENTS, PSYCHIC_M, REFLECT
	dbp 72, EYOUMU
		db LEFTOVERS
		db PETAL_SLASH, MOONBLAST, LIGHT_SCREEN, ANCIENTPOWER
	db -1 ; end
	...
	dbp 72, EREISEN
		db LEFTOVERS
		db HELL_TOKAMAK, FOCUS_BLAST, EARTH_POWER, SMOKESCREEN
	db -1 ; end
	...
	dbp 72, ESANAE
		db LEFTOVERS
		db SURF, AVARICE_BITE, SLASH, OUTRAGE
	db -1 ; end
...
Lyra1Group:
	...
	dbp 17, MARILL
		db NO_ITEM, "@"
		ev_spread 72 Atk
		db DEFENSE_CURL, ROLLOUT, BUBBLE_BEAM, LUNAR_BULLET ; default for level
	dbp 15, MAREEP
		db NO_ITEM, "@"
...
YoungsterGroup:
	...
	dbp 40, CELIS, MALE
		...
		db MASTER_SPARK, QUICK_ATTACK, POWER_BITE, PURSUIT
	db -1 ; end
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 8, EMUGETSU
	dbp LEVEL_FROM_BADGES + 9, QUAGSIRE
	dbp LEVEL_FROM_BADGES + 8, ESARIEL
	db -1 ; end
...
CamperGroup:
	...
	dbp LEVEL_FROM_BADGES + 5, CORANGE
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 8, MARISA
	db -1 ; end
...
if DEF(FAITHFUL)
		...
		db LEECH_SEED, GIGA_DRAIN, SUNNY_DAY, METEOR_FALL
endc
	dbp 34, JUMPLUFF
	...
	dbp 36, KOTOHIME
		db SLEEP_POWDER, ACID, HEALINGLIGHT, PETAL_SLASH
	db -1 ; end
	...
	dbp LEVEL_FROM_BADGES + 6, EMUGETSU
	db -1 ; end
...
TwinsGroup:
	...
	; party
	dbp 38, YUKARI
		db THUNDER_WAVE, DRAGON_PULSE, METEOR_FALL, HEADBUTT
	dbp 38, YUKARI
...
FisherGroup:
	...
	; party
	dbp 36, QWILFISH
		db TOXIC, MINIMIZE, SURF, PWJ_NEEDLE
	dbp 36, LANTURN
		db REVERSAL, WATERFALL, THUNDERBOLT, CONFUSE_RAY
	dbp 39, CLETTY
		db WATERFALL, SPIDERS_NEST, FURY_STRIKES, POISON_JAB
	db -1 ; end
	...
	; party
	dbp 43, CELLY
		db RAIN_DANCE, HYPNOSIS, WATERFALL, SCULPTURE
	dbp 43, CLETTY
		db SPIDERS_NEST, WATERFALL, BODY_SLAM, POISON_JAB
	dbp 45, QWILFISH
		db ROLLOUT, WATERFALL, PWJ_NEEDLE, TAKE_DOWN
	db -1 ; end
	...
	dbp 40, CLETTY
		db WATERFALL, BODY_SLAM, POISON_JAB, SPIDERS_NEST
	dbp 42, OCTILLERY
	...
	; party
	dbp 20, LILYBLACK, MALE | LILYBLACK_CALICO1_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 25, LILYBLACK, MALE | LILYBLACK_CALICO2_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 30, ELILYBLACK, MALE
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
	...
	; party
	dbp 30, LILYBLACK, MALE | LILYBLACK_CALICO2_FORM
		db ABILITY_1 | NAT_NEUTRAL
		db SPLASH, TACKLE, REVERSAL, DRAGON_RAGE
	dbp 30, LILYBLACK, MALE | LILYBLACK_CALICO3_FORM
		db ABILITY_1 | NAT_NEUTRAL
		db SPLASH, TACKLE, REVERSAL, DRAGON_RAGE
	dbp 30, LILYBLACK, MALE | LILYBLACK_TWO_TONE_FORM
		db ABILITY_1 | NAT_NEUTRAL
		db SPLASH, TACKLE, REVERSAL, DRAGON_RAGE
	dbp 30, LILYBLACK, MALE | LILYBLACK_ORCA_FORM
		db ABILITY_1 | NAT_NEUTRAL
		db SPLASH, TACKLE, REVERSAL, DRAGON_RAGE
	db -1 ; end
	...
	; party
	dbp 36, REMORAID
		db METEOR_FALL, PSYBEAM, AURORA_BEAM, BUBBLE_BEAM
	dbp 36, REMORAID
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp LEVEL_FROM_BADGES + 5, LILYBLACK, MALE | PLAIN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp LEVEL_FROM_BADGES + 5, LILYBLACK, MALE | LILYBLACK_DAPPLES_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp LEVEL_FROM_BADGES + 5, LILYBLACK, MALE | LILYBLACK_TIGER_FORM
		db ABILITY_1 | NAT_NEUTRAL
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp 51, LILYBLACK, MALE | LILYBLACK_MASK1_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 52, LILYBLACK, MALE | LILYBLACK_CALICO1_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 53, LILYBLACK, MALE | LILYBLACK_CALICO2_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 54, LILYBLACK, MALE | LILYBLACK_CALICO3_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 55, LILYBLACK, MALE | LILYBLACK_TWO_TONE_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 56, LILYBLACK, MALE | LILYBLACK_ORCA_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp 48, LILYBLACK, MALE | PLAIN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 48, LILYBLACK, MALE | LILYBLACK_BUBBLES_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 48, LILYBLACK, MALE | LILYBLACK_CALICO3_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
...
BirdKeeperGroup:
	...
	dbp LEVEL_FROM_BADGES + 7, EYUMEMI
		db SURF, DISABLE, SCREECH, LUNAR_BASH
	db -1 ; end
...
GruntMGroup:
	...
	dbp 33, HOUNDOUR, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 34, CYUMEKO, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
	...
	dbp 23, CELIS, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 24, CYUMEMI, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp 26, CHIYURI, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 26, CSHINKI, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 27, CELIS, MALE
...
GruntFGroup:
	...
	; party
	dbp 29, KIKURI
		db GLARE, SCREECH, ACID, AVARICE_BITE
	dbp 28, QWILFISH
...
PokemaniacGroup:
	...
	; party
	dbp 42, CLUNASA
		db RECOVER, PSYCHIC_M, CONVERSION, FIVEELEMENTS
	db -1 ; end
...
endc
	...
	dbp LEVEL_FROM_BADGES + 5, FGYOKU
	db -1 ; end
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 2, SARA, FEMALE
	dbp LEVEL_FROM_BADGES + 2, ORANGE, FEMALE
	db -1 ; end
...
BugManiacGroup:
	...
	dbp LEVEL_FROM_BADGES + 9, ERIKAKO
	db -1 ; end
...
SchoolboyGroup:
	...
	dbp 38, TANGROWTH
		db ANCIENTPOWER, TOXIC_GAS, VINE_WHIP, MEGA_DRAIN
	dbp 37, YANMA
...
HexManiacGroup:
	...
	dbp 56, CELLEN
		db PSYCHIC_M, SHADOW_BALL, CONFUSE_RAY, METEOR_FALL
	db -1 ; end
...
CoupleGroup:
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp LEVEL_FROM_BADGES + 6, EMERLIN, MALE
		db ABILITY_1 | NAT_NEUTRAL
...
RichBoyGroup:
	...
	dbp LEVEL_FROM_BADGES + 4, CREMILIA, FEMALE
		...
		db HEADBUTT, FRESH_SNACK, SWEET_KISS, LUNAR_BASH
...
BreederGroup:
	...
	dbp 27, TYROGUE
		db EVIOLITE
		db TACKLE, RAGE, FORESIGHT, TENSION_KICK
	dbp 28, MUNCHLAX
		db EVIOLITE
	...
	dbp 58, SMEARGLE, FEMALE
		db WISE_GLASSES, ABILITY_1 | NAT_NEUTRAL
		db SPORE, NASTY_PLOT, VOICE_BIND, PSYCHIC_M
	dbp 58, SMEARGLE, FEMALE
...
CowgirlGroup:
	...
	dbp LEVEL_FROM_BADGES + 5, CLILYBLACK, MALE
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_CLILYBLACK_ANGER_POINT | NAT_ATK_UP_SATK_DOWN
		db LUNAR_BASH, QUICK_ATTACK, PURSUIT, BULK_UP
	db -1 ; end
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 6, CLILYBLACK
	dbp LEVEL_FROM_BADGES + 7, CLILYBLACK, PALDEAN_FORM
	dbp LEVEL_FROM_BADGES + 8, CLILYBLACK, CLILYBLACK_PALDEAN_FIRE_FORM
	dbp LEVEL_FROM_BADGES + 9, CLILYBLACK, CLILYBLACK_PALDEAN_WATER_FORM
	db -1 ; end
...
SailorGroup:
	...
	; party
	dbp 38, POLITOED
		db WHIRLPOOL, RAIN_DANCE, BODY_SLAM, SHADOW_DANCE
	dbp 38, CELLY
		db SURF, STRENGTH, ICE_PUNCH, SCULPTURE
	db -1 ; end
...
SwimmerMGroup:
	...
	dbp LEVEL_FROM_BADGES + 2, ELETTY
	...
	dbp LEVEL_FROM_BADGES + 4, ELETTY
	db -1 ; end
	...
	dbp 57, AZUMARILL, MALE
		...
		db AQUA_TAIL, PLAY_ROUGH, ROLLOUT, SCULPTURE
	db -1 ; end
...
SwimmerFGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 5, ELETTY
	db -1 ; end
...
BurglarGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY
	; party
	dbp 44, EKOAKUMA, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
	dbp 46, CPATCHOULI, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
	dbp 46, LILYWHITE, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
	dbp 48, CYUMEMI, MALE | ALOLAN_FORM
...
ScientistGroup:
	...
	dbp LEVEL_FROM_BADGES + 5, CLUNASA
	dbp LEVEL_FROM_BADGES + 6, EALICE
	db -1 ; end
...
BoarderGroup:
	...
	dbp 36, PILOSWINE, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 37, ESARIEL, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
...
SkierGroup:
	...
	dbp 38, YUKI, FEMALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 38, CELLEN, FEMALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
...
;	db -1 ; end
	...
	dbp 27, EMEILING
		db "Bruce@"
		db DOUBLE_KICK, BULK_UP, TENSION_KICK, FOCUS_ENERGY
	db -1 ; end
...
BattleGirlGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 8, EMEILING
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 7, EMEILING
...
DragonTamerGroup:
	...
	dbp 38, EMARISA
		db SLASH, FLY, SPIRIT_VOICE, FLAME_CHARGE
	db -1 ; end
...
endc
	...
	; party
	dbp 40, EYUKARI
		db THUNDER_WAVE, DRAGON_RAGE, AQUA_TAIL, METEOR_FALL
	dbp 40, EYUKARI
	...
	dbp LEVEL_FROM_BADGES + 8, CSUIKA, MALE
		db FOCUS_SASH, ABIL_CSUIKA_MULTISCALE | NAT_ATK_UP_SATK_DOWN
		ev_spread 252 Atk, 12 Spe
		db FOCUS_ENERGY, SPIRIT_VOICE, EARTHQUAKE, ICE_PUNCH
	...
	dbp LEVEL_FROM_BADGES + 8, EMARISA, MALE
		db FOCUS_SASH, ABIL_EMARISA_BLAZE | NAT_ATK_UP_SATK_DOWN
		ev_spread 132 Atk, 132 Spe
		db DRAGON_DANCE, SPIRIT_VOICE, EARTHQUAKE, LAVATEIN
	db -1 ; end
...
EngineerGroup:
	...
	db TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp LEVEL_FROM_BADGES + 2, CSARA, MALE | ALOLAN_FORM
		db ABIL_CSARA_ALOLAN_GALVANIZE | NAT_NEUTRAL
...
GuitaristFGroup:
	...
	dbp 55, CSARIEL, FEMALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
		db EXTREMESPEED, SURF, THUNDERBOLT, SPIDERS_NEST
	db -1 ; end
...
ArtistGroup:
	...
	dbp 55, SMEARGLE
		...
		db HELL_TOKAMAK, METEOR_FALL, EARTH_POWER, WILL_O_WISP
	dbp 55, SMEARGLE
...
SightseerFGroup:
	...
	dbp LEVEL_FROM_BADGES + 6, MERLIN, FEMALE
		db FLAME_ORB, DVS_HP_ICE, ABIL_MERLIN_QUICK_FEET | NAT_SATK_UP_ATK_DOWN
		ev_spread 168 SAt
...
CooltrainerMGroup:
	...
	dbp 45, EMERLIN
		db NO_ITEM
		db METEOR_FALL, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	dbp 26, CREIMU
		db LEECH_SEED, TOXIC_GAS, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	dbp 35, EALICE
		db THUNDER_WAVE, THUNDERBOLT, FIVEELEMENTS, FLASH_CANNON
	db -1 ; end
...
CooltrainerFGroup:
	...
	; party
	dbp 40, LUIZE
		db STOMP, FIRE_SPIN, PLAY_ROUGH, SPIDERS_NEST
	dbp 39, FLAAFFY
...
endc
	...
	dbp 49, LUIZE
		db FOCUS_BAND
		db STOMP, FIRE_SPIN, PLAY_ROUGH, HELL_TOKAMAK
	dbp 48, AMPHAROS
		db NO_ITEM
if DEF(FAITHFUL)
		db THUNDERBOLT, THUNDER_WAVE, LIGHT_SCREEN, SWIFT
...
endc
	...
	; party
	dbp 35, CREIMU
		db GROWL, LEECH_SEED, TOXIC_GAS, RAZOR_LEAF
	dbp 36, REIMU
		db GROWL, LEECH_SEED, TOXIC_GAS, RAZOR_LEAF
	dbp 37, EREIMU
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp LEVEL_FROM_BADGES + 4, EMUGETSU, FEMALE
		db BINDING_BAND, ABIL_EMUGETSU_LIMBER | NAT_SPE_UP_DEF_DOWN
		ev_spread 104 HP
		db WRAP, SLEEP_POWDER, TOXIC_GAS, STUN_SPORE
	dbp LEVEL_FROM_BADGES + 4, AZUMARILL, FEMALE
		db BINDING_BAND, ABIL_AZUMARILL_SAP_SIPPER | NAT_SPE_UP_DEF_DOWN
		ev_spread 104 HP
		db WHIRLPOOL, SHADOW_DANCE, AQUA_TAIL, PROTECT
	dbp LEVEL_FROM_BADGES + 5, MARISA, FEMALE
		db BINDING_BAND, ABIL_MARISA_PICKUP | NAT_SPE_UP_DEF_DOWN
		ev_spread 104 HP
...
VeteranMGroup:
	...
	dbp 39, KURUMI
		db CHARCOAL
		db FLAME_CHARGE, METEOR_FALL, DOUBLE_KICK, TAKE_DOWN
	dbp 37, ESARIEL
		db HARD_STONE
...
endc
	dbp 41, CELLEN
		db CHARCOAL
		db METEOR_FALL, SHADOW_BALL, CONFUSE_RAY, LUNACY_EYES
	dbp 39, CGENGETSU
		db MIRACLE_SEED
...
endc
	...
	dbp 60, CSUIKA
		db MUSCLE_BAND
		db SPIRIT_VOICE, DRAGON_DANCE, FLY, EARTHQUAKE
	dbp 60, RAN
		db QUICK_CLAW
		db ICE_BEAM, DIVE_KICK, WHITE_BIRD, U_TURN
	dbp 60, ERAN
		db WISE_GLASSES
		db THUNDERBOLT, AIR_SLASH, WHITE_BIRD, LUNACY_EYES
	dbp 60, CYUKARI
		db FOCUS_BAND
		db METEOR_FALL, DIVE_KICK, WILL_O_WISP, ANCIENTPOWER
	dbp 60, KURUMI
		db SHELL_BELL
...
VeteranFGroup:
	...
	dbp 41, EREIMU
		db MIRACLE_SEED
		db GROWTH, SLUDGE_BOMB, PETAL_SLASH, SLEEP_POWDER
	dbp 38, MIMA
		db QUICK_CLAW
		db WHITE_BIRD, FLY, SWIFT, ROAR
	dbp 39, CHEN
		db EVIOLITE
	...
	dbp LEVEL_FROM_BADGES + 11, CLUNASA_Z, FEMALE
		db CHOICE_SPECS, DVS_HP_GROUND, ABIL_CLUNASA_Z_ADAPTABILITY | NAT_SATK_UP_ATK_DOWN
		ev_spread 252 SAt, 44 Spe
	...
	dbp 60, KINGDRA
		db WISE_GLASSES
		db SURF, DRAGON_PULSE, ICE_BEAM, METEOR_FALL
	db -1 ; end
...
ProtonGroup:
	...
	dbp 41, CPATCHOULI
		db CHARCOAL
		db HELL_TOKAMAK, EXPLOSION, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
...
PetrelGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 39, EKOAKUMA, MALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
		db TACKLE, EXPLOSION, VENOSHOCK, SMOKESCREEN
	dbp 39, KOTOHIME, MALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
		db LEECH_LIFE, AERIAL_ACE, CONFUSE_RAY, LIFE_COUNTER
	dbp 40, CYUMEKO, MALE | ALOLAN_FORM
		db HARD_STONE, ABILITY_1 | NAT_NEUTRAL
		db FIRE_PUNCH, KNOCK_OFF, POISON_JAB, ROCK_SLIDE
	dbp 41, CPATCHOULI, MALE
		db SILK_SCARF, ABILITY_1 | NAT_NEUTRAL
		db TACKLE, EXPLOSION, VENOSHOCK, SMOKESCREEN
	dbp 39, CELIS, MALE | ALOLAN_FORM
		db BLACKGLASSES, ABILITY_1 | NAT_NEUTRAL
		db QUICK_ATTACK, SCREECH, AVARICE_BITE, LIFE_COUNTER
	db -1 ; end
	...
	dbp 34, KOTOHIME, MALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
		ev_spread 216 Atk
		db BITE, AERIAL_ACE, CONFUSE_RAY, LIFE_COUNTER
	dbp 35, CYUMEKO, MALE | ALOLAN_FORM
		db BLACKGLASSES, ABILITY_1 | NAT_NEUTRAL
		ev_spread 108 Atk, 108 Spe
		db MINIMIZE, AVARICE_BITE, VENOSHOCK, KNOCK_OFF
	dbp 35, CELIS, MALE | ALOLAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		ev_spread 108 Atk, 108 Spe
		db SWORDS_DANCE, AVARICE_BITE, LIFE_COUNTER, POWER_BITE
...
ArcherGroup:
	...
	dbp 41, HOUNDOUR, MALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
		db LIFE_COUNTER, FIRE_SPIN, FEINT_ATTACK, WILL_O_WISP
	dbp 43, CELIS, MALE | ALOLAN_FORM
		db BLACKGLASSES, ABILITY_1 | NAT_NEUTRAL
		db AVARICE_BITE, LIFE_COUNTER, POWER_BITE, DOUBLE_EDGE
	dbp 41, ESHINKI, MALE
		db SPELL_TAG, ABILITY_1 | NAT_NEUTRAL
	...
	dbp 44, HOUNDOOM, MALE
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		db SMOKESCREEN, LIFE_COUNTER, FEINT_ATTACK, METEOR_FALL
	db -1 ; end
	...
	dbp 32, HOUNDOOM, MALE
		...
		db METEOR_FALL, SMOKESCREEN, FEINT_ATTACK, LIFE_COUNTER
	db -1 ; end
...
ArianaGroup:
	...
	dbp 35, KIKURI, FEMALE | KIKURI_ARIANA_FORM
		db BLACKGLASSES, ABILITY_1 | NAT_NEUTRAL
		db WRAP, ACID, AVARICE_BITE, GLARE
	dbp 36, KANA, FEMALE
		db MIRACLE_SEED, ABILITY_1 | NAT_NEUTRAL
...
GiovanniGroup:
	...
	dbp LEVEL_FROM_BADGES + 24, SUIKA, MALE | SUIKA_ARMORED_FORM
		db ARMOR_SUIT, ABIL_SUIKA_INSOMNIA | NAT_SATK_UP_ATK_DOWN, "?????@"
	...
	dbp 60, HONCHKROW, FEMALE
		...
		db SUCKER_PUNCH, DRAGON_DRILL, WHITE_BIRD, THUNDER_WAVE
	dbp 60, EREMILIA, FEMALE
if !DEF(FAITHFUL)
		db LUM_BERRY, ABIL_EREMILIA_PRESSURE | NAT_SPE_UP_SATK_DOWN
		db BODY_SLAM, SEISMIC_TOSS, ICE_PUNCH, AVARICE_BITE
else
		db LEFTOVERS, ABIL_EREMILIA_KEEN_EYE | NAT_ATK_UP_SATK_DOWN
		db DOUBLE_EDGE, EARTHQUAKE, AVARICE_BITE, REST
endc
	dbp 62, EPATCHOULI, MALE
if !DEF(FAITHFUL)
		db EVIOLITE, ABIL_EPATCHOULI_ADAPTABILITY | NAT_ATK_UP_SATK_DOWN
else
		db EVIOLITE, ABIL_EPATCHOULI_BATTLE_ARMOR | NAT_ATK_UP_SATK_DOWN
endc
...
ProfOakGroup:
	...
	dbp 78, CLILYBLACK, MALE
		db CHOICE_SCARF, ABIL_CLILYBLACK_INTIMIDATE | NAT_ATK_UP_SATK_DOWN
	...
	dbp 80, EMARISA, MALE
if !DEF(FAITHFUL)
		db LIFE_ORB, ABIL_EMARISA_BLAZE | NAT_SPE_UP_SATK_DOWN
else
		db LIFE_ORB, ABIL_EMARISA_DROUGHT | NAT_SPE_UP_SATK_DOWN
endc
		db LAVATEIN, SPIRIT_VOICE, AVARICE_BITE, DRAGON_DANCE
	dbp 80, ESAKUYA, MALE
...
ProfElmGroup:
	...
	dbp LEVEL_FROM_BADGES + 4, EELLEN
	...
	dbp LEVEL_FROM_BADGES + 5, EELLEN
	dbp LEVEL_FROM_BADGES + 6, EREISEN
	dbp LEVEL_FROM_BADGES + 6, EYOUMU
	dbp LEVEL_FROM_BADGES + 6, ESANAE
	db -1 ; end
	...
	dbp LEVEL_FROM_BADGES + 8, EELLEN
	dbp LEVEL_FROM_BADGES + 8, HERACROSS
	dbp LEVEL_FROM_BADGES + 9, EREISEN
	dbp LEVEL_FROM_BADGES + 9, EYOUMU
	dbp LEVEL_FROM_BADGES + 9, ESANAE
	db -1 ; end
...
KarateKingGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	dbp LEVEL_FROM_BADGES + 11, EMEILING
		db BLACK_BELT
		db BULK_UP, FOCUS_ENERGY, TENSION_KICK, FORESIGHT
...
TowerTycoonGroup:
	...
	dbp 74, ELILYBLACK
		db MUSCLE_BAND
		db DRAGON_DANCE, WATERFALL, AVARICE_BITE, OUTRAGE
	dbp 74, RHYPERIOR
		db KINGS_ROCK
		db EARTHQUAKE, ROCK_SLIDE, DRAGON_BASH, AVALANCHE
	dbp 75, CSUIKA
		db WISE_GLASSES
		db HURRICANE, DRAGON_PULSE, HELL_TOKAMAK, BLIZZARD
	dbp 73, CYUKA
		db TWISTEDSPOON
		db PSYCHIC_M, CONFUSE_RAY, FIVEELEMENTS, LIGHT_SCREEN
	dbp 73, CRAN
		db LEFTOVERS
		db SLEEP_TALK, REST, BODY_SLAM, GUNK_SHOT
	dbp 72, HERACROSS
		db BLACK_BELT
		db DRAGON_BASH, CROSS_CHOP, SEISMIC_TOSS, NIGHT_SLASH
	db -1 ; end
...
LoreleiGroup:
	...
	dbp 44, ECHEN
		db SITRUS_BERRY
		ev_spread 240 SAt
		db DRAINING_KISS, SING, AVALANCHE, PETAL_SLASH
	dbp 43, CLYRICA
		db NO_ITEM
...
AgathaGroup:
	...
	dbp 62, CROBAT, FEMALE
		...
		db AIR_SLASH, AVARICE_BITE, ICHIGO_CROSS, POISON_JAB
	dbp 61, MISDREAVUS, FEMALE
		db EVIOLITE, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 HP, 108 SAt
		db SHADOW_BALL, METEOR_FALL, ENERGY_LIGHT, POWER_GEM
if DEF(FAITHFUL)
	...
	dbp 61, MEILING, FEMALE | ALOLAN_FORM
		db THICK_CLUB, ABILITY_1 | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	...
	dbp 72, MEILING, FEMALE | ALOLAN_FORM
		db THICK_CLUB, ABILITY_1 | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	dbp 58, MAGNEZONE, MALE
		db WISE_GLASSES, ABILITY_1 | NAT_NEUTRAL
		db THUNDERBOLT, FLASH_CANNON, FIVEELEMENTS, EXPLOSION
else
	dbp 58, ESAKUYA, MALE
		db WISE_GLASSES, ABILITY_1 | NAT_NEUTRAL
		db SURF, BLIZZARD, FLASH_CANNON, AURA_SPHERE
endc
	dbp 58, ESARIEL, MALE | ALOLAN_FORM
...
endc
	dbp 76, MAGNEZONE, MALE
		db WISE_GLASSES, ABILITY_1 | NAT_NEUTRAL
		db THUNDERBOLT, FLASH_CANNON, FIVEELEMENTS, EXPLOSION
	dbp 76, ESARIEL, MALE | ALOLAN_FORM
		db NEVERMELTICE, ABILITY_1 | NAT_NEUTRAL
		db IRON_HEAD, ICICLE_CRASH, EARTHQUAKE, RAPID_SPIN
	dbp 76, EYUYUKO, MALE
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
...
endc
	dbp 62, URSALUNA
		db LEFTOVERS
		db EARTHQUAKE, SHADOW_HIT, PLAY_ROUGH, GUNGNIR
	dbp 61, GLISCOR
		db KINGS_ROCK
		db SWORDS_DANCE, NIGHT_SLASH, ICHIGO_CROSS, SCREECH
	db -1 ; end
...
ValerieGroup:
	...
	dbp 36, AZUMARILL
		db NO_ITEM
		ev_spread 224 Atk
		db PLAY_ROUGH, AQUA_TAIL, LUNAR_BULLET, ROLLOUT
	dbp 38, TOGETIC
		db NO_ITEM
		ev_spread 224 SAt
	...
	dbp 57, CCHEN, FEMALE
		db QUICK_CLAW, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 HP, 68 Def
		db PSYCHIC_M, ENERGY_LIGHT, LIGHT_SCREEN, REFLECT
	dbp 56, AZUMARILL, FEMALE
		db MUSCLE_BAND, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 Atk, 68 Spe
		db PLAY_ROUGH, WATERFALL, LUNAR_BULLET, SCULPTURE
	dbp 56, LUIZE, FEMALE | GALARIAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 Atk, 68 Spe
		db METEOR_FALL, LUNAR_BASH, PLAY_ROUGH, SWORDS_DANCE
	...
	dbp 72, AZUMARILL, FEMALE
		db MUSCLE_BAND, ABILITY_1 | NAT_NEUTRAL
		db PLAY_ROUGH, WATERFALL, RETURN, SCULPTURE
	dbp 72, LUIZE, FEMALE | GALARIAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		db HELL_TOKAMAK, LUNAR_BASH, PLAY_ROUGH, BLAZE_STAR
...
KukuiGroup:
	...
	; party
	; TODO: movesets, etc
	dbp 67, MEILING, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
		ev_spread 236 Atk, 252 Spe
	dbp 65, CELLEN, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	...
	dbp 65, CELIS, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
		ev_spread 236 Atk, 252 Spe
	dbp 68, ECIRNO, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	...
	; party
	; TODO: movesets, etc
	dbp 74, MEILING, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 72, CELLEN, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 73, MAGNEZONE, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 73, CRAN, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 72, CYUMEKO, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 75, ECIRNO, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
...
PiersGroup:
	...
	dbp 17, CYUMEKO, MALE | ALOLAN_FORM
	dbp 19, CELIS, MALE | ALOLAN_FORM
	db -1 ; end
	...
	dbp LEVEL_FROM_BADGES + 16, CYUMEKO, MALE | ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 14, CYUMEMI, MALE | ALOLAN_FORM
if DEF(FAITHFUL)
	dbp LEVEL_FROM_BADGES + 14, UMBREON, MALE
else
	dbp LEVEL_FROM_BADGES + 14, GIRAFARIG, MALE
endc
	dbp LEVEL_FROM_BADGES + 19, CELIS, MALE | ALOLAN_FORM
	db -1 ; end
...
BillGroup:
	...
	dbp 62, EMERLIN
		db CHARCOAL
		db LAVATEIN, DOUBLE_EDGE, SMOKESCREEN, ROCK_SMASH
	dbp 63, LEAFEON
		db MIRACLE_SEED
		db SEED_BOMB, SWORDS_DANCE, HEALINGLIGHT, ICHIGO_CROSS
	dbp 63, GLACEON
		db NEVERMELTICE
...
YellowGroup:
	...
	dbp LEVEL_FROM_BADGES + 5, EMIMA, FEMALE
		db SITRUS_BERRY, ABIL_EMIMA_SCRAPPY | NAT_ATK_UP_SATK_DOWN, "Ratty@"
		ev_spread 240 Atk
	...
	dbp LEVEL_FROM_BADGES + 4, LUNASA, FEMALE
		db SITRUS_BERRY, ABIL_LUNASA_SHELL_ARMOR | NAT_NEUTRAL, "Omny@"
		ev_spread 240 HP
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	dbp 72, ELUNASA, FEMALE
		db WISE_GLASSES, ABIL_ELUNASA_SHELL_ARMOR | NAT_NEUTRAL, "Omny@"
		db SCALD, ANCIENTPOWER, SPIKES, ICE_BEAM
	dbp 73, CELIS, FEMALE
		db KINGS_ROCK, ABIL_CELIS_PRESSURE | NAT_ATK_UP_SATK_DOWN, "Ratty@"
		db SWORDS_DANCE, QUICK_ATTACK, LIFE_COUNTER, AVARICE_BITE
...
WalkerGroup:
	...
	dbp LEVEL_FROM_BADGES + 5, NOCTOWL
		db NO_ITEM
		ev_spread 184 Spe
		db AERIAL_ACE, NIGHT_SHADE, REFLECT, LUNACY_EYES
	dbp LEVEL_FROM_BADGES + 6, ELIS
		db NO_ITEM
		ev_spread 184 SAt
		db MUD_SLAP, WHITE_BIRD, SWIFT, AIR_SLASH
	dbp LEVEL_FROM_BADGES + 5, EYUYUKO
		db NO_ITEM
		ev_spread 184 Atk
	...
	dbp 74, MIMA
		db BRIGHTPOWDER
		db WHITE_BIRD, EXTREMESPEED, HURRICANE, ROAR
	dbp 73, EYUYUKO
		db MUSCLE_BAND
	...
	dbp 73, EMARISA
		db CHARCOAL
if DEF(FAITHFUL)
		db SWORDS_DANCE, HELL_TOKAMAK, ROCK_SLIDE, AERIAL_ACE
else
		db SWORDS_DANCE, HELL_TOKAMAK, ROCK_SLIDE, SPIRIT_VOICE
endc
	dbp 72, XATU
		db QUICK_CLAW
		db FUTURE_SIGHT, LIFE_BALANCE, REFLECT, PSYCHIC_M
	db -1 ; end
...
if DEF(FAITHFUL)
		db SWORDS_DANCE, LAVATEIN, SLASH, AERIAL_ACE
else
		db SWORDS_DANCE, LAVATEIN, SLASH, SPIRIT_VOICE
endc
	dbp 68, CSUIKA, MALE
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL
	...
	dbp 67, TYRANITAR, MALE
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		db EARTHQUAKE, STONE_EDGE, AVARICE_BITE, SCARY_FACE
...
ReiGroup:
	...
	dbp 59, EMERLIN
		...
		db QUICK_ATTACK, ROCK_SMASH, DOUBLE_EDGE, LAVATEIN
	dbp 58, HONCHKROW
		db BLACKGLASSES
		ev_spread 68 Atk, 252 Spe
		db DRAGON_DRILL, SUCKER_PUNCH, PURSUIT, DIVE_KICK
	...
	dbp 58, LUIZE
		db KINGS_ROCK
		ev_spread 68 HP, 252 Spe
		db HELL_TOKAMAK, DRAGON_BASH, POISON_JAB, WILL_O_WISP
	dbp 60, CELLEN
		db LEFTOVERS
		ev_spread 68 SAt, 252 Spe
		db NASTY_PLOT, METEOR_FALL, DARK_PULSE, SHADOW_BALL
	db -1 ; end
	...
	dbp 73, LUIZE
		db KINGS_ROCK
		db LAVATEIN, DRAGON_BASH, POISON_JAB, WILL_O_WISP
	dbp 75, CELLEN
		db LEFTOVERS
		db NASTY_PLOT, HELL_TOKAMAK, DARK_PULSE, SHADOW_BALL
	db -1 ; end
