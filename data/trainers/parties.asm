...
CarrieGroup:
	...
	dbp 60, SKARMORY
		db ROCKY_HELMET
		db SPIKES, WHITE_BIRD, DRILL_PECK, STEEL_WING
	dbp 60, HOUNDOOM
		db POISON_BARB
...
FalknerGroup:
	...
	dbp 72, DODRIO
		db SILK_SCARF
		db DRILL_PECK, BULLDOZE, PURSUIT, DIVE_KICK
	dbp 70, TOGEKISS
		db LEFTOVERS
...
BrunoGroup:
	...
	dbp 53, SNEASLER
		db SILVERPOWDER
		ev_spread 176 Atk, 176 Spe
		db SWORDS_DANCE, X_SCISSOR, SCULPTURE, GUNK_SHOT
	dbp 51, HITMONLEE
		db FOCUS_BAND
		ev_spread 176 Atk, 176 Spe
...
KarenGroup:
	...
	dbp 55, HONCHKROW, FEMALE
		...
		db DRILL_PECK, SUCKER_PUNCH, PURSUIT, DIVE_KICK
	...
	dbp 73, HONCHKROW
		db BLACKGLASSES
		db DRILL_PECK, SUCKER_PUNCH, NIGHT_SLASH, DIVE_KICK
	dbp 74, TYRANITAR
		db SOFT_SAND
...
ChampionGroup:
	...
	dbp 58, DRAGONITE, MALE
		...
		db FIRE_BLAST, BLIZZARD, THUNDER, MASTER_SPARK
	dbp 58, KINGDRA, MALE
...
if DEF(FAITHFUL)
	...
	dbp 75, EMARISA, MALE
		...
		db DRAGON_DANCE, OUTRAGE, FLARE_BLITZ, WHITE_BIRD
endc
...
BlaineGroup:
	...
	dbp 75, RAPIDASH
		db POISON_BARB
		db MEGAHORN, POISON_JAB, FLARE_BLITZ, BLAZE_STAR
	db -1 ; end
...
ArtistGroup:
	...
	dbp 55, SMEARGLE
		...
		db FIRE_BLAST, METEOR_FALL, EARTH_POWER, WILL_O_WISP
	dbp 55, SMEARGLE
...
ArcherGroup:
	...
	dbp 44, HOUNDOOM, MALE
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		db SMOKESCREEN, SUPER_FANG, FEINT_ATTACK, METEOR_FALL
	db -1 ; end
	...
	dbp 32, HOUNDOOM, MALE
		...
		db METEOR_FALL, SMOKESCREEN, FEINT_ATTACK, SUPER_FANG
	db -1 ; end
...
GiovanniGroup:
	...
	dbp 60, HONCHKROW, FEMALE
		...
		db SUCKER_PUNCH, DRILL_PECK, WHITE_BIRD, THUNDER_WAVE
...
ProfOakGroup:
	...
	dbp 76, DODRIO, FEMALE
		...
		db DIVE_KICK, HI_JUMP_KICK, KNOCK_OFF, QUICK_ATTACK
...
endc
	dbp 62, URSALUNA
		db LEFTOVERS
		db EARTHQUAKE, SHADOW_HIT, PLAY_ROUGH, GIGA_IMPACT
	dbp 61, GLISCOR
		db KINGS_ROCK
...
ValerieGroup:
	...
	dbp 72, RAPIDASH, FEMALE | GALARIAN_FORM
		db KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL
		db FIRE_BLAST, ZEN_HEADBUTT, PLAY_ROUGH, BLAZE_STAR
