...
if DEF(FAITHFUL)
	...
	dbp 24, NOCTOWL, MALE
		...
		db HYPNOSIS, FORESIGHT, PSYSHOT, HEX
endc
...
CamperGroup:
	...
	dbp LEVEL_FROM_BADGES + 6, ESARIEL
	db -1 ; end
...
endc
	...
	; party
	dbp 31, CMEIRA
		db ENCORE, SING, FIVEELEMENTS, MINIMIZE
	db -1 ; end
...
GruntMGroup:
	...
	dbp 32, CELIS, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 32, CELIS, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 33, ECHIYURI, MALE
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp 26, ECHIYURI, MALE | ALOLAN_FORM
		db ABILITY_1 | NAT_NEUTRAL
	dbp 26, GASTLY, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp 27, CELIS, MALE
...
LassGroup:
	...
	dbp 19, YUMEMI
		db SCRATCH, LEER, DISABLE, PSYSHOT
	db -1 ; end
...
CooltrainerMGroup:
	...
	dbp LEVEL_FROM_BADGES + 3, CKOTOHIME, MALE
		db MIRACLE_SEED, $EE, $EE, $EE, ABIL_CKOTOHIME_INNER_FOCUS | NAT_SATK_UP_SDEF_DOWN
		ev_spread 20 HP
...
ProtonGroup:
	...
	dbp 39, KOTOHIME
		db KINGS_ROCK
		db AERIAL_ACE, CONFUSE_RAY, LIFE_COUNTER, POISON_JAB
	dbp 40, QWILFISH
		db BRIGHTPOWDER
...
GiovanniGroup:
	...
	dbp 62, CHIYURI, MALE
		db CHOICE_BAND, ABIL_CHIYURI_ARENA_TRAP | NAT_SPE_UP_SATK_DOWN
...
ReiGroup:
	...
	dbp LEVEL_FROM_BADGES + 2, MURKROW
		db NO_ITEM
		ev_spread 120 Spe
	dbp LEVEL_FROM_BADGES + 4, CELLEN
		db SITRUS_BERRY
		ev_spread 120 Spe
	db -1 ; end
