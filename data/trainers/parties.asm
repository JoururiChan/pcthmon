...
ChampionGroup:
	...
	dbp 57, EMARISA, MALE
		db WISE_GLASSES, ABIL_EMARISA_SOLAR_POWER | NAT_SATK_UP_ATK_DOWN
		ev_spread 164 SAt, 252 Spe
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	...
	dbp 75, EMARISA, MALE
		db LEFTOVERS, ABIL_EMARISA_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
...
if DEF(FAITHFUL)
	...
	dbp 88, EMARISA, MALE
		db MUSCLE_BAND, ABIL_EMARISA_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
...
endc
	...
	dbp LEVEL_FROM_BADGES + 5, MARISA, FEMALE
		db BINDING_BAND, ABIL_MARISA_SOLAR_POWER | NAT_SPE_UP_DEF_DOWN
		ev_spread 104 HP
...
ProfOakGroup:
	...
	dbp 80, EMARISA, MALE
if !DEF(FAITHFUL)
		db LIFE_ORB, ABIL_EMARISA_TOUGH_CLAWS | NAT_SPE_UP_SATK_DOWN
else
		db LIFE_ORB, ABIL_EMARISA_DROUGHT | NAT_SPE_UP_SATK_DOWN
endc
		db FLARE_BLITZ, DRAGON_CLAW, CRUNCH, DRAGON_DANCE
	dbp 80, ESAKUYA, MALE
		db WHITE_HERB, ABIL_ESAKUYA_TORRENT | NAT_SDEF_UP_SATK_DOWN
...
YellowGroup:
	...
	dbp LEVEL_FROM_BADGES + 3, FGYOKU, FEMALE
		db SITRUS_BERRY, ABIL_FGYOKU_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, "Kitty@"
		ev_spread 240 Spe
	...
	dbp 71, FGYOKU, FEMALE
		db BRIGHTPOWDER, ABIL_FGYOKU_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, "Free@"
