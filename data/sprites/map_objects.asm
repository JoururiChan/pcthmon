...
; entries correspond to SPRITEMOVEDATA_* constants
	...
	sprite_movement_data SPRITEMOVEFN_BIG_SLILYBLACK,          DOWN,   OBJECT_ACTION_BIG_SLILYBLACK,     $2e,    $01,    %1100 ; SPRITEMOVEDATA_BIG_SLILYBLACK
	...
	sprite_movement_data SPRITEMOVEFN_TOHOCOM_NEWS,          DOWN,   OBJECT_ACTION_TOHOCOM_NEWS,     $8e,    $02,    %0000 ; SPRITEMOVEDATA_TOHOCOM_NEWS
