...
; FIGY BERRY
	item_attribute 10, HELD_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; POMEG BERRY
	item_attribute 10, HELD_NO_SEED_PELT, MON_HP_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; KELPSY BERRY
	item_attribute 10, HELD_NO_SEED_PELT, MON_ATK_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; QUALOT BERRY
	item_attribute 10, HELD_NO_SEED_PELT, MON_DEF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HONDEW BERRY
	item_attribute 10, HELD_NO_SEED_PELT, MON_SAT_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; GREPA BERRY
	item_attribute 10, HELD_NO_SEED_PELT, MON_SDF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TAMATO BERRY
	item_attribute 10, HELD_NO_SEED_PELT, MON_SPE_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LIECHI BERRY
