...
MomItems_1:
	...
	momitem      0,   180, MOM_ITEM, TOHO_BALL
...
MomItems_2:
	...
	momitem  10000,  1800, MOM_DOLL, DECO_KURUMI_DOLL
	momitem  15000,  1890, MOM_ITEM, MOON_STONE
	momitem  20000,  2700, MOM_ITEM, ELIXIR
	momitem  30000,  4800, MOM_DOLL, DECO_CMEIRA_DOLL
	momitem  40000,  3600, MOM_ITEM, CHOICE_SCARF
	momitem  50000,  8000, MOM_DOLL, DECO_EKIKURI_DOLL
	momitem  70000, 11200, MOM_DOLL, DECO_TEIRIN_DOLL
.End
