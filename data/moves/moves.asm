...
endc
	move ENERGY_LIGHT, EFFECT_NORMAL_HIT,         80, GRASS,     100, 10,   0, SPECIAL
...
if DEF(FAITHFUL)
	move LAVATEIN,     EFFECT_DEFENSE_DOWN_HIT,  150, FIRE,       95,  5,  10, PHYSICAL
else
	move LAVATEIN,     EFFECT_BRICK_BREAK,       150, FIRE,       95,  5,  10, PHYSICAL
endc
	...
	move POISON_NAIL,  EFFECT_POISON_HIT,         60, POISON,     95, 20,  20, PHYSICAL
...
endc
	...
	move SEAL_NEEDLE,  EFFECT_PARALYZE_HIT,       40, NORMAL,    100, 20,  20, PHYSICAL
	move U_TURN,       EFFECT_SWITCH_HIT,         70, BUG,       100, 20,   0, PHYSICAL
	move PWJ_NEEDLE,   EFFECT_ALWAYS_HIT,         65, NORMAL,     -1, 20,   0, PHYSICAL
...
endc
	...
	move MASTER_SPARK, EFFECT_MASTER_SPARK,      160, ELECTRIC,   80,  5,   0, SPECIAL
	move PECK,         EFFECT_NORMAL_HIT,         35, FLYING,    100, 35,   0, PHYSICAL
	move DRAGON_DRILL, EFFECT_FLINCH_HIT,         80, DRAGON,    100, 15,  20, PHYSICAL
...
endc
	...
	move FLOWER_SHOOT, EFFECT_FLOWER_SHOOT,         90, GRASS,      90, 10,   0, SPECIAL
	...
	move DOLL_STRINGS, EFFECT_CONFUSE,             0, NORMAL,     80, 20,   0, STATUS
...
endc
	...
	move TENSION_KICK, EFFECT_SPEED_DOWN_HIT,     65, FIGHTING,   80, 10,  90, PHYSICAL
	...
	move RECOLLECT,    EFFECT_RECOLLECT,           0, NORMAL,     -1, 10,   0, STATUS
	move WATER_PULSE,  EFFECT_CONFUSE_HIT,        60, WATER,     100, 20,  20, SPECIAL
	move LUNAR_BULLET, EFFECT_SP_DEF_DOWN_HIT,    70, FAIRY,     100, 10,  20, SPECIAL
	move SPORE,        EFFECT_CONFUSE,             0, GRASS,     100, 15,   0, STATUS
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  60, PSYCHIC,    90, 20,   0, SPECIAL
	move LUNACY_EYES,  EFFECT_CONFUSE_HIT,        80, FAIRY,      40, 15, 100, SPECIAL
...
endc
	...
	move FIVEELEMENTS, EFFECT_FIVEELEMENTS,      110, PSYCHIC,   100, 10,  30, SPECIAL
	...
	move LUNAR_BASH,   EFFECT_FLINCH_HIT,         70, FAIRY,      95, 15,  15, PHYSICAL
	...
	move VOICE_BIND,   EFFECT_NORMAL_HIT,         90, DRAGON,    100, 10,   0, SPECIAL
...
endc
	...
	move POWER_TRICK,  EFFECT_POWER_TRICK,         0, PSYCHIC,    -1, 15,   0, STATUS
	...
	move DRAGON_BASH,  EFFECT_NORMAL_HIT,        100, DRAGON,     90, 10,   0, PHYSICAL
...
endc
	...
	move BRAVER,       EFFECT_DEFENSE_DOWN_HIT,  120, GROUND,     75,  5,  30, PHYSICAL
...
endc
	...
	move AVARICE_BITE, EFFECT_LEECH_HIT,         100, POISON,    100, 10,   0, PHYSICAL
