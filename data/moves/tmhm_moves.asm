...
; entries correspond to *_TMNUM constants (see constants/item_constants.asm)
	...
	db TENSION_KICK   ; TM15 (Goldenrod Dept. Store)
	...
	db METEOR_FALL ; TM35 (Goldenrod Game Corner)
	db SLUDGE_BOMB  ; TM36 (Route 43)
	db SANDSTORM    ; TM37 (Celadon Dept. Store)
	db HELL_TOKAMAK   ; TM38 (Goldenrod Dept. Store)
	...
	db ICHIGO_CROSS    ; TM56 (Underground Warehouse)
	db BLAZE_STAR  ; TM57 (Lt. Surge)
	...
	db LUNAR_BULLET ; MT31 (Saffron City)
