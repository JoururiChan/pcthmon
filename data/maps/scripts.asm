...
INCLUDE "maps/RuinsOfAlphCIchirinChamber.asm"
...
INCLUDE "maps/RuinsOfAlphCIchirinItemRoom.asm"
...
INCLUDE "maps/RuinsOfAlphCIchirinWordRoom.asm"
...
INCLUDE "maps/EcruteakTKogasaSpeechHouse.asm"
...
INCLUDE "maps/CianwoodTKogasaSpeechHouse.asm"
