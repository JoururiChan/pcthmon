...
ENDM
	...
	map_attributes RuinsOfAlphEYuyukoChamber, RUINS_OF_ALPH_AYUYUKO_CHAMBER, $0, 0
	...
	map_attributes RuinsOfAlphEYuyukoItemRoom, RUINS_OF_ALPH_AYUYUKO_ITEM_ROOM, $0, 0
	...
	map_attributes RuinsOfAlphEYuyukoWordRoom, RUINS_OF_ALPH_AYUYUKO_WORD_ROOM, $0, 0
