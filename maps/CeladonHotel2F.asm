CeladonHotel2F_MapScriptHeader:
	...
	def_object_events
	object_event 11,  2, SPRITE_TOHOFAN_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonHotel2FTeacherText, -1
