VermilionPort_MapScriptHeader:
	...
	object_event 11, 11, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 2, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, VermilionPortSuperNerdText, -1
...
VermilionPortSailorAtGangwayScript:
	...
	clearevent EVENT_BEAT_TOHOMANIAC_ETHAN
	clearevent EVENT_BEAT_BURGLAR_COREY
	clearevent EVENT_BEAT_BUG_CATCHER_KEN
	clearevent EVENT_BEAT_GUITARISTM_CLYDE
	clearevent EVENT_BEAT_TOHOFANM_JEREMY
	clearevent EVENT_BEAT_TOHOFANF_GEORGIA
