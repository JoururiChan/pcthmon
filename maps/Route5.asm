Route5_MapScriptHeader:
	...
	def_object_events
	object_event 17, 28, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, Route5TohofanMText, EVENT_ROUTE_5_6_TOHOFAN_M_BLOCKS_UNDERGROUND_PATH
