GoldenrodHarbor_MapScriptHeader:
	...
	object_event 22, 15, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodHarborTohofanmScript, -1
