LavenderTownSpeechHouse_MapScriptHeader:
	...
	def_object_events
	object_event  2,  3, SPRITE_MATRON, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, LavenderSpeechHouseTohofanFText, -1

LavenderSpeechHouseTohofanFText:
	text "Lavender is a"
