AzaleaTown_MapScriptHeader:
	...
	object_event  8, 17, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, WAKASAGI, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, PLAIN_FORM, AzaleaTownWakasagiScript, EVENT_AZALEA_TOWN_WAKASAGIS
	object_event 18,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, WAKASAGI, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, PLAIN_FORM, AzaleaTownWakasagiScript, EVENT_AZALEA_TOWN_WAKASAGIS
	object_event 30,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, WAKASAGI, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, PLAIN_FORM, AzaleaTownWakasagiScript, EVENT_AZALEA_TOWN_WAKASAGIS
	object_event 15, 15, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, WAKASAGI, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, PLAIN_FORM, AzaleaTownWakasagiScript, EVENT_AZALEA_TOWN_WAKASAGIS
	tohomon_event 14, 12, WOOPER, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_BLUE, AzaleaTownWoosterText, EVENT_WAKASAGI_WELL_WAKASAGIS
	tohomon_event 14, 12, QUAGSIRE, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_BLUE, AzaleaTownWoosterText, EVENT_AZALEA_TOWN_WAKASAGIS
