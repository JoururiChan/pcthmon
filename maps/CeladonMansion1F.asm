CeladonMansion1F_MapScriptHeader:
	...
	tohomon_event  2,  6, CHIYURI, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_BROWN, CeladonMansion1FEChiyuriText, -1
	tohomon_event  3,  4, CMEIRA, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_PINK, CeladonMansion1FCMeiraText, -1
	tohomon_event  4,  4, CKONGARA, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_TEAL, CeladonMansion1FCKongaraText, -1
...
CeladonMansion1FEChiyuriText:
	text "EChiyuri: Meow!"
	done

CeladonMansion1FCMeiraText:
	text "CMeira: Clef"
	line "cleff!"
	done
