RadioTower4F_MapScriptHeader:
	...
	tohomon_event 12,  7, CHIYURI, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_BROWN, RadioTowerChiyuriText, -1
...
RadioTowerChiyuriText:
	text "Chiyuri: Chiyuri…"
	done
