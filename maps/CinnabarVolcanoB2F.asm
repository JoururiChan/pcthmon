CinnabarVolcanoB2F_MapScriptHeader:
	...
	def_object_events
	object_event 18, 22, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, CYUKARI, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, PLAIN_FORM, CinnabarVolcanoCYukari, EVENT_CINNABAR_VOLCANO_CYUKARI
