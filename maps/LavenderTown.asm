LavenderTown_MapScriptHeader:
	...
	def_warp_events
	warp_event  5,  7, LAVENDER_TOHOCENTER_1F, 1
...
;	coord_event 10,  5, 0, LavenderTownExpositionTrigger3
	...
	object_event  2, 17, SPRITE_TOHOFAN_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, LavenderTownTeacherText, -1
	...
	object_event  8, 18, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, LavenderTownSuperNerdText, EVENT_LAVENDER_TOWN_FLEEING_YOUNGSTER ; TODO: EVENT_EXORCISED_LAV_RADIO_TOWER
