WarehouseEntrance_MapScriptHeader:
	...
	object_event  5, 14, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, OlderHaircutBrotherScript, EVENT_WAREHOUSE_ENTRANCE_OLDER_HAIRCUT_BROTHER
	object_event  5, 15, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, YoungerHaircutBrotherScript, EVENT_WAREHOUSE_ENTRANCE_YOUNGER_HAIRCUT_BROTHER
	...
	object_event  1, 27, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, GenericTrainerTohomaniacIssac, -1
	object_event  0,  6, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerTohomaniacDonald, -1
	...
	object_event 14, 25, SPRITE_CMIMA_SIDE, SPRITEMOVEDATA_MICROPHONE, 0, 0, -1, -1, PAL_NPC_EMOTE_GRAY, OBJECTTYPE_COMMAND, jumptextfaceplayer, PiersMicrophoneText, -1
...
GenericTrainerTohomaniacIssac:
	generictrainer TOHOMANIAC, ISSAC, EVENT_BEAT_TOHOMANIAC_ISSAC, TohomaniacIssacSeenText, TohomaniacIssacBeatenText
...
GenericTrainerTohomaniacDonald:
	generictrainer TOHOMANIAC, DONALD, EVENT_BEAT_TOHOMANIAC_DONALD, TohomaniacDonaldSeenText, TohomaniacDonaldBeatenText
