KurtsHouse_MapScriptHeader:
	...
	tohomon_event  6,  3, CKOMACHI, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_PINK, KurtsHouseWakasagiText, EVENT_KURTS_HOUSE_WAKASAGI
...
TohomonJournalProfWestwoodScript:
