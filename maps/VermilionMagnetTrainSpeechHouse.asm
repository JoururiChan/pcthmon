VermilionMagnetTrainSpeechHouse_MapScriptHeader:
	...
	def_object_events
	object_event  2,  3, SPRITE_MATRON, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, VermilionMagnetTrainSpeechHouseTohofanFText, -1
...
VermilionMagnetTrainSpeechHouseTohofanFText:
