CeladonUniversityPool_MapScriptHeader:
	...
	object_event  3,  8, SPRITE_TOHOFAN_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversityPoolTeacherText, -1
