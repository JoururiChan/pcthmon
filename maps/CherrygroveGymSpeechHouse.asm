CherrygroveGymSpeechHouse_MapScriptHeader:
	...
	def_object_events
	object_event  2,  3, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, CherrygroveGymSpeechHouseTohofanMText, -1
