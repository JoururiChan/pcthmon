QuietCaveB1F_MapScriptHeader:
	...
	object_event 21, 17, SPRITE_POKEMANIAC, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 4, GenericTrainerTohomaniacAidan, -1
...
GenericTrainerTohomaniacAidan:
	generictrainer POKEMANIAC, AIDAN, EVENT_BEAT_POKEMANIAC_AIDAN, TohomaniacAidanSeenText, TohomaniacAidanBeatenText
...
TohomaniacAidanBeatenText: ; text > text
	text "My #mon…"
	done
