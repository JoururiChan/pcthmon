QuietCaveB1F_MapScriptHeader:
	...
	object_event 21, 17, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 4, GenericTrainerTohomaniacAidan, -1
...
GenericTrainerTohomaniacAidan:
	generictrainer TOHOMANIAC, AIDAN, EVENT_BEAT_TOHOMANIAC_AIDAN, TohomaniacAidanSeenText, TohomaniacAidanBeatenText
