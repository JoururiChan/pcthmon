BattleTower2F_MapScriptHeader:
	...
	object_event 17,  8, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, BattleTower2FSuperNerdText, EVENT_QUIET_CAVE_MARLEY
	tohomon_event 18,  8, KIKURI, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, BattleTower2FKikuriText, EVENT_QUIET_CAVE_MARLEY
