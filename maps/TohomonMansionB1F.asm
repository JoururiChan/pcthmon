TohomonMansionB1F_MapScriptHeader:
	def_scene_scripts

	def_callbacks

	def_warp_events
	warp_event 25, 24, TOHOMON_MANSION_1F, 3
	...
	bg_event  5, 17, BGEVENT_JUMPTEXT, TohomonMansion1FFlowerPotText
	bg_event  8, 17, BGEVENT_JUMPTEXT, TohomonMansion1FFlowerPotText
	bg_event  9, 17, BGEVENT_JUMPTEXT, TohomonMansion1FFlowerPotText
	...
	object_event 18, 22, SPRITE_BOOK_PAPER_TOHODEX, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, TohomonMansionDiaryText, -1
	itemball_event 13,  5, CARBOS, 1, EVENT_TOHOMON_MANSION_B1F_CARBOS
	itemball_event  7,  6, CALCIUM, 1, EVENT_TOHOMON_MANSION_B1F_CALCIUM
	itemball_event 16, 27, HP_UP, 1, EVENT_TOHOMON_MANSION_B1F_HP_UP
	keyitemball_event  4, 23, OLD_SEA_MAP, EVENT_TOHOMON_MANSION_B1F_OLD_SEA_MAP
