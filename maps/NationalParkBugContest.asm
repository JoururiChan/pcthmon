NationalParkBugContest_MapScriptHeader:
	...
	object_event  9, 13, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant4AScript, EVENT_BUG_CATCHING_CONTESTANT_4A
