MahoganyRedSLilyBlackSpeechHouse_MapScriptHeader:
	...
	object_event  6,  5, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, MahoganyRedSLilyBlackSpeechHouseTeacherScript, -1
