CeladonDeptStore6F_MapScriptHeader:
	...
	def_object_events
	object_event  9,  2, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonDeptStore6FSuperNerdText, -1
