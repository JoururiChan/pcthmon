WakasagihimeWellB1F_MapScriptHeader:
	...
	object_event  7,  4, SPRITE_WAKASAGITAIL, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WakasagihimeWellB1FWakasagiWithMailScript, EVENT_WAKASAGIHIME_WELL_WAKASAGIS
	object_event  6,  2, SPRITE_WAKASAGITAIL, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WakasagihimeWellB1FTaillessWakasagiScript, EVENT_WAKASAGIHIME_WELL_WAKASAGIS
...
Proton2Script:
	...
	setevent EVENT_WAKASAGIHIME_WELL_WAKASAGIS
