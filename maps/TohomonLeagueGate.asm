TohomonLeagueGate_MapScriptHeader:
	def_scene_scripts
	...
	def_coord_events
	coord_event 10, 10, 0, TohomonLeagueGateXYTriggerScript1
	coord_event 11, 10, 0, TohomonLeagueGateXYTriggerScript2
	...
	object_event 14,  5, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, VictoryRoadGateRightBlackBeltText, EVENT_FOUGHT_CRAN

TohomonLeagueGateXYTriggerScript2:
	applyonemovement PLAYER, step_left
TohomonLeagueGateXYTriggerScript1:
