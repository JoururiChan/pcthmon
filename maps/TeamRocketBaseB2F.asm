TeamRocketBaseB2F_MapScriptHeader:
	...
	object_event  7,  5, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, CCIRNO, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, NO_FORM, RocketCCirno1, EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_1
	object_event  7,  7, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, CCIRNO, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, NO_FORM, RocketCCirno2, EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_2
	object_event  7,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, CCIRNO, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, NO_FORM, RocketCCirno3, EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_3
	tohomon_event 22,  5, CCIRNO, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_1
	tohomon_event 22,  7, CCIRNO, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_2
	tohomon_event 22,  9, CCIRNO, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_3
