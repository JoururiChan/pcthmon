TeamRocketBaseB2F_MapScriptHeader:
	...
	object_event  7,  5, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, ELECTRODE, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, NO_FORM, RocketElectrode1, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_1
	object_event  7,  7, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, ELECTRODE, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, NO_FORM, RocketElectrode2, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_2
	object_event  7,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, ELECTRODE, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, NO_FORM, RocketElectrode3, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_3
	tohomon_event 22,  5, ELECTRODE, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_1
	tohomon_event 22,  7, ELECTRODE, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_2
	tohomon_event 22,  9, ELECTRODE, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_3
...
RocketBaseElectrodeScript:
	...
	setevent EVENT_MAHOGANY_TOWN_TOHOFAN_M_BLOCKS_GYM
	setscene $3
