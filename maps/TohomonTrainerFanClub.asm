TohomonTrainerFanClub_MapScriptHeader:
	def_scene_scripts
	...
	def_bg_events
	bg_event  0, 10, BGEVENT_READ, TohomonJournalBrunoScript
	bg_event  1, 10, BGEVENT_READ, TohomonJournalBrunoScript

	def_object_events

TohomonJournalBrunoScript:
