MountMortar1FInside_MapScriptHeader:
	...
	object_event 33, 43, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerTohomaniacMiller, -1
...
GenericTrainerTohomaniacMiller:
	generictrainer TOHOMANIAC, MILLER, EVENT_BEAT_TOHOMANIAC_MILLER, TohomaniacMillerSeenText, TohomaniacMillerBeatenText
