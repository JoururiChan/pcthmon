FastShipCabins_NNW_NNE_NE_MapScriptHeader:
	...
	object_event  1,  5, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerTohomaniacEthan, EVENT_FAST_SHIP_PASSENGERS_WESTBOUND
...
GenericTrainerTohomaniacEthan:
	generictrainer TOHOMANIAC, ETHAN, EVENT_BEAT_TOHOMANIAC_ETHAN, TohomaniacEthanSeenText, TohomaniacEthanBeatenText
...
TohomaniacEthanSeenText:
	text "Do you know Lily?"
	line "She's a hot DJ in"
	cont "Kanto."
	done

TohomaniacEthanBeatenText:
	text "Gyaaaah!"
	done
