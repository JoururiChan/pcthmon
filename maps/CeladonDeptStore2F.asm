CeladonDeptStore2F_MapScriptHeader:
	...
	object_event  5,  2, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonDeptStore2FTohofanMText, -1
...
CeladonDeptStore2FTohofanMText:
