CeladonCity_MapScriptHeader:
	...
	pokemon_event 31, 11, CELLY, SPRITEMOVEDATA_POKEMON, -1, -1, PAL_NPC_BLUE, CeladonCityCEllyText, -1
	...
	object_event 45, 10, SPRITE_BIG_CRAN, SPRITEMOVEDATA_CRAN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_8_CRAN
