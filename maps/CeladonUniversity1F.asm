CeladonUniversity1F_MapScriptHeader:
	...
	def_object_events
	object_event  6,  5, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity1FSuperNerdText, -1
	...
	object_event  6, 15, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 3, -1, (1 << EVE) | (1 << NITE), PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity1FTohofanmText, -1
...
CeladonUniversity1FTohofanmText:
