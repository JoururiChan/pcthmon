MountMoonB1F_MapScriptHeader:
	...
	def_object_events
	object_event  5, 20, SPRITE_HIKER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_COMMAND, jumptextfaceplayer, MountMoonB1FTohofanmText, -1

MountMoonB1FTohofanmText:
