NoisyForest_MapScriptHeader:
	...
	object_event 24, 31, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, AYA, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, NO_FORM, NoisyForestPikabluScript, EVENT_NOISY_FOREST_PIKABLU
