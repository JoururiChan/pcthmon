SinjohRuinsHouse_MapScriptHeader:
	...
	object_event  5,  3, SPRITE_HIKER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, SinjohRuinsHouseTohofanmText, -1
	...
	tohomon_event  2,  3, ELLY, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_BROWN, SinjohRuinsHouseAbraText, -1
