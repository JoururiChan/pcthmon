Route34IlexForestGate_MapScriptHeader:
	...
	pokemon_event  9,  4, CKONGARA, SPRITEMOVEDATA_POKEMON, -1, -1, PAL_NPC_BLUE, Route34IlexForestGateCKongaraText, EVENT_ROUTE_34_ILEX_FOREST_GATE_TEACHER_BEHIND_COUNTER
...
Route34IlexForestGateTeacher_GotSweetScent:
	...
	para "It always moves"
	line "first. Use it in"

	para "situations where"
	line "HP is low."
	done
