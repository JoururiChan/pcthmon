CeladonUniversityLibrary1F_MapScriptHeader:
	...
	object_event  3,  8, SPRITE_MATRON, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversityLibrary1FTohofan_fText, -1
	...
	object_event 10,  3, SPRITE_BOOK_PAPER_TOHODEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, CeladonUniversityLibrary1FBookText, -1
...
CeladonUniversityLibrary1FTohofan_fText:
