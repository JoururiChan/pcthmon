GoldenrodMuseum1F_MapScriptHeader:
	...
	def_object_events
	object_event  1,  2, SPRITE_ELUIZETAIL, SPRITEMOVEDATA_MUSEUM_DRILL_DOWN, 0, 0, -1, -1, PAL_NPC_DRILL, OBJECTTYPE_COMMAND, end, NULL, -1
	object_event  2,  2, SPRITE_ELUIZETAIL, SPRITEMOVEDATA_MUSEUM_DRILL_UP, 0, 0, -1, -1, PAL_NPC_DRILL, OBJECTTYPE_COMMAND, end, NULL, -1
