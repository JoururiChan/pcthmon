GoldenrodMuseum1F_MapScriptHeader:
	...
	def_object_events
	object_event  1,  2, SPRITE_WAKASAGITAIL, SPRITEMOVEDATA_MUSEUM_DRILL_DOWN, 0, 0, -1, -1, PAL_NPC_DRILL, OBJECTTYPE_COMMAND, end, NULL, -1
	object_event  2,  2, SPRITE_WAKASAGITAIL, SPRITEMOVEDATA_MUSEUM_DRILL_UP, 0, 0, -1, -1, PAL_NPC_DRILL, OBJECTTYPE_COMMAND, end, NULL, -1
	...
	object_event 12,  3, SPRITE_BIG_CLYRICA, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PEARL, OBJECTTYPE_COMMAND, jumptext, GoldenrodMuseum1FBigPearlText, -1
