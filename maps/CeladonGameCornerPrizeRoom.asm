...
CeladonGameCornerPrizeRoom_MapScriptHeader:
	...
	object_event  5,  1, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonGameCornerTohomonVendor, -1
...
CeladonGameCornerTohomonVendor:
	faceplayer
	opentext
	writetext CeladonPrizeRoom_PrizeVendorIntroText
	waitbutton
...
.clunasa
	...
	setmonval CLUNASA
	special Special_GameCornerPrizeMonCheckDex
	takecoins CELADONGAMECORNERPRIZEROOM_CLUNASA_COINS
	sjump .loop
