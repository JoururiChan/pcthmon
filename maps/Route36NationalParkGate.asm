Route36NationalParkGate_MapScriptHeader:
	...
	object_event  6,  5, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant4BScript, EVENT_BUG_CATCHING_CONTESTANT_4B
	...
	const ROUTE36NATIONALPARKGATE_TOHOFAN_M
...
.Not3:
	...
	iftruefwd .Not4
	appear ROUTE36NATIONALPARKGATE_TOHOFAN_M
.Not4:
