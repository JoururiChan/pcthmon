TeamRocketBaseB3F_MapScriptHeader:
	...
	object_event  7,  2, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, MURKROW, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, NO_FORM, RocketBaseMurkrow, EVENT_TEAM_ROCKET_BASE_POPULATION
