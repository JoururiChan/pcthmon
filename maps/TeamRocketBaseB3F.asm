TeamRocketBaseB3F_MapScriptHeader:
	...
	object_event  7,  2, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, MINORIKO, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, NO_FORM, RocketBaseMinoriko, EVENT_TEAM_ROCKET_BASE_POPULATION
