FuchsiaCity_MapScriptHeader:
	...
	object_event 22, 13, SPRITE_EMIMA_BACK, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, SafariZoneOfficeClosedSignText, -1
	object_event 31, 27, SPRITE_EMIMA_BACK, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, HouseForSaleSignText, -1
