CeladonGameCorner_MapScriptHeader:
	...
	object_event 14, 10, SPRITE_TOHOFAN_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonGameCornerTohofanMScript, -1
	object_event 17,  7, SPRITE_TOHOFAN_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeladonGameCornerTeacherScript, -1
...
CeladonGameCornerTohofanMScript:
	showtextfaceplayer CeladonGameCornerTohofanMText
