LyrasHouse2F_MapScriptHeader:
	...
	bg_event  7,  1, BGEVENT_READ, TohomonJournalProfElmScript
	...
	tohomon_event  3,  3, MIMA, SPRITEMOVEDATA_TOHOMON, -1, -1, PAL_NPC_BROWN, LyrasHouseMimaText, EVENT_LYRA_IN_HER_ROOM
