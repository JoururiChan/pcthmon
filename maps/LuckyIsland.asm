LuckyIsland_MapScriptHeader:
	...
	def_object_events
	object_event 27, 18, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TOHO_BALL, OBJECTTYPE_SCRIPT, 0, LuckyIslandLuckyEgg, EVENT_LUCKY_ISLAND_LUCKY_EGG
...
LuckyIslandLuckyEgg:
	giveitem LUCKY_EGG
	iffalsefwd .NoRoom
	disappear LUCKYISLAND_TOHO_BALL
