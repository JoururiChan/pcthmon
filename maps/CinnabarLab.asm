CinnabarLab_MapScriptHeader:
	...
	object_event 15,  4, SPRITE_ARMORED_TSUIKATWO, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
	...
	tohomon_event 15,  7, TSUIKATWO, SPRITEMOVEDATA_STILL, -1, -1, PAL_NPC_PURPLE, ClearText, EVENT_CINNABAR_LAB_TSUIKATWO
...
CinnabarLabCelebiEventScript:
	...
	setevent EVENT_CINNABAR_LAB_TSUIKATWO
	...
	showemote EMOTE_SHOCK, CINNABARLAB_ARMORED_TSUIKATWO, 15
	opentext
	writetext CinnabarLabTSuikatwoText
	cry TSUIKATWO
	waitsfx
	closetext
	...
	waitsfx
	pause 15
	applymovement CINNABARLAB_ARMORED_TSUIKATWO, CinnabarLabTSuikatwoFloatsDownMovementData
	...
	cry TSUIKATWO
	waitsfx
	turnobject CINNABARLAB_ARMORED_TSUIKATWO, LEFT
	...
	turnobject CINNABARLAB_ARMORED_TSUIKATWO, RIGHT
	...
	turnobject CINNABARLAB_ARMORED_TSUIKATWO, UP
	...
	scall CinnabarLabShowPlayer
	turnobject CINNABARLAB_ARMORED_TSUIKATWO, DOWN
	pause 30
	applyonemovement CINNABARLAB_ARMORED_TSUIKATWO, slow_step_down
	playsound SFX_KINESIS
	special FadeOutPalettes
	special LoadMapPalettes
	pause 15
	disappear CINNABARLAB_ARMORED_TSUIKATWO
	appear CINNABARLAB_TSUIKATWO
	waitsfx
...
CinnabarLabTSuikatwoFloatsDownMovementData:
	set_sliding
	jump_step_down
	remove_sliding
	step_end
