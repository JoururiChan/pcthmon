Route10North_MapScriptHeader:
	...
	def_object_events
	object_event 13, 44, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, TRAN, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, PLAIN_FORM, Route10TRan, EVENT_ROUTE_10_TRAN
	...
	object_event 14, 52, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, TRAN, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, PLAIN_FORM, ObjectEvent, EVENT_LAWRENCES_TRAN_ROUTE_10
