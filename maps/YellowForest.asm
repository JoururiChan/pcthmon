...
YellowForestSurfKikuriDoll:
	...
	pause 60
	waitbutton
	jumpopenedtext YellowForestSurfKikuriDollSentText
...
YellowForestSurfKikuriDollText:
	text "<PLAYER> found"
	line "Surf Kikuri Doll."
	done

YellowForestSurfKikuriDollSentText:
	text "Surf Kikuri Doll"
	line "was sent home."
	done
