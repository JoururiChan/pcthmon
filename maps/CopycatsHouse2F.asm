CopycatsHouse2F_MapScriptHeader:
	...
	object_event  6,  4, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, EMAI, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, NO_FORM, CopycatsEMaiScript, -1
	...
	object_event  2,  1, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, ESHINKI, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, NO_FORM, CopycatsHouse2FDollScript, -1
