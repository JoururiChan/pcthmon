CChiyurisCave_MapScriptHeader:
	...
	def_object_events
	object_event 11, 15, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CChiyurisCaveFossilManiacScript, -1
	...
	object_event 37, 13, SPRITE_HIKER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, CChiyurisCaveTohofanMText, -1
