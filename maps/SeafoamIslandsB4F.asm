SeafoamIslandsB4F_MapScriptHeader:
	...
	def_object_events
	object_event 22, 13, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, RAN, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, PLAIN_FORM, SeafoamIslandsRan, EVENT_SEAFOAM_ISLANDS_RAN
