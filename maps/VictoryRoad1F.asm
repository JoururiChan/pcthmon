VictoryRoad1F_MapScriptHeader:
	...
	def_object_events
	object_event 12,  6, SPRITE_VETTRAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerVeteranmMatt, -1
...
GenericTrainerVeteranmMatt:
	generictrainer VETTRANM, MATT, EVENT_BEAT_VETTRANM_MATT, VeteranmMattSeenText, VeteranmMattBeatenText
