GoldenrodDeptStore6F_MapScriptHeader:
	...
	object_event  8,  2, SPRITE_TOHOMANIAC, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, GoldenrodDeptStore6FSuperNerdText, -1
