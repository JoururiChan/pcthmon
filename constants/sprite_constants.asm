...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_TOHOFAN_M ; 7b
	const SPRITE_TOHOFAN_F ; 7c
	const SPRITE_TOHOMANIAC ; 7d
	...
	const SPRITE_VETTRAN_M ; 92
	const SPRITE_VETTRAN_F ; 93
	...
	const SPRITE_BOOK_PAPER_TOHODEX ; b5
