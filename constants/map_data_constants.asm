...
; FishGroup indexes (see data/wild/fish.asm)
	...
	const FISHGROUP_YUKARI
	const FISHGROUP_CSUWAKO_SWARM
	const FISHGROUP_CYAMAME_SWARM
	const FISHGROUP_SLILYBLACK
	const FISHGROUP_YUKARI_2
	const FISHGROUP_WHIRL_ISLANDS
	const FISHGROUP_CSUWAKO
	const FISHGROUP_CYAMAME
