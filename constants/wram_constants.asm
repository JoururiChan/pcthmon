...
; wPlayerCaught::
	...
	const PLAYER_CAUGHT_ERAN_F   ; 6
	const PLAYER_CAUGHT_CYUKARI_F  ; 7

; wPlayerCaught2::
	const_def
	const PLAYER_CAUGHT_ESUIKA_F       ; 0
...
DEF CAUGHT_BIRDS_MASK  EQU (1 << PLAYER_CAUGHT_RAN_F) | (1 << PLAYER_CAUGHT_ERAN_F) | (1 << PLAYER_CAUGHT_CYUKARI_F)
