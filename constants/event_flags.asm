...
; More Crystal-exclusive events in Johto
	...
	const EVENT_CREIMU_FROM_IVY
	const EVENT_CMARISA_FROM_IVY
	const EVENT_CSAKUYA_FROM_IVY
...
; Johto itemballs
	const EVENT_CALICE_POKEBALL_IN_ELMS_LAB
	const EVENT_CREISEN_POKEBALL_IN_ELMS_LAB
	const EVENT_CSANAE_POKEBALL_IN_ELMS_LAB
...
; TODO: rearrange
	...
	const EVENT_BEAT_BLACK_BELT_RYLAN
	...
	const EVENT_CHERRYGROVE_BAY_FOUGHT_GALARIAN_RAN
	const EVENT_CHERRYGROVE_BAY_FOUGHT_GALARIAN_TRAN
	const EVENT_CHERRYGROVE_BAY_FOUGHT_GALARIAN_CYUKARI
	const EVENT_PUSHED_GAME_CORNER_SWITCH
	const EVENT_RICH_BOY_TOBIN
