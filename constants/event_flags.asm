...
; Johto Gym Leader TM gifts
	...
	const EVENT_GOT_TM59_ENIGMA_BURST
...
; Kanto story events
	...
	const EVENT_GOT_TM71_STONE_RISE
	...
	const EVENT_GOT_HOLY_FLAME_LILYBLACK
	...
	const EVENT_LISTENED_TO_HOLY_CHARGE_INTRO
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_KITRAN
...
; VeteranM
	const EVENT_BEAT_VETTRANM_MATT
	const EVENT_BEAT_VETTRANM_REMY
	const EVENT_BEAT_VETTRANM_BARKHORN
; VeteranF
	const EVENT_BEAT_VETTRANF_JOANNE
	const EVENT_BEAT_VETTRANF_JONET
	const_skip ; unused
	const EVENT_BEAT_VETTRANF_LITVYAK
; Proton
...
; Johto itemballs
	...
	const EVENT_UNDERGROUND_WAREHOUSE_TM_CRASH_CROSS
	...
	const EVENT_ROUTE_26_TM_SHADOW_FORCE
