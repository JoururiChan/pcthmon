...
; wUnlockedHinas
	const ENGINE_UNLOCKED_HINAS_A_TO_J
	const ENGINE_UNLOCKED_HINAS_K_TO_Q
	const ENGINE_UNLOCKED_HINAS_R_TO_W
	const ENGINE_UNLOCKED_HINAS_X_TO_QUESTION
	const_skip 4 ; unused
; wVisitedSpawns
...
; wPokemonJournals
	...
	const ENGINE_READ_ERIKA_T_JOURNAL
...
; wPlayerCaught2
	...
	const ENGINE_PLAYER_CAUGHT_GALARIAN_RAN
	const ENGINE_PLAYER_CAUGHT_GALARIAN_TRAN
	const ENGINE_PLAYER_CAUGHT_GALARIAN_CYUKARI
