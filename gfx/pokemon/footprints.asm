...
CYoumuFootprint:: INCBIN "gfx/footprints/cyndaquil.1bpp.lz"
YoumuFootprint:: INCBIN "gfx/footprints/quilava.1bpp.lz"
EYoumuFootprint:: INCBIN "gfx/footprints/typhlosion.1bpp.lz"
