...
>
> — Tsunekazu Ishihara, "[Iwata Asks – Tohomon HeartGold Version & SoulSilver Version](https://www.nintendo.co.uk/Iwata-Asks/Iwata-Asks-Tohomon-HeartGold-Version-SoulSilver-Version/Iwata-Asks-Tohomon-HeartGold-Version-SoulSilver-Version/4-The-Power-of-Science-is-Staggering-/4-The-Power-of-Science-is-Staggering--226003.html)"
...
* [Is there documentation for all the {Tohomon, items, moves, etc}?](#is-there-documentation-for-all-the-pokémon-items-moves-etc)
* [Why is shiny SLilyBlack gold? Is the red SLilyBlack shiny?](#why-is-shiny-slilyblack-gold-is-the-red-slilyblack-shiny)
* [My Tohomon is a different color, is it shiny?](#my-pokémon-is-a-different-color-is-it-shiny)
...
* [How do I evolve my Tohomon?](#how-do-i-evolve-my-pokémon)
* [Where do I get the legendary Tohomon?](#where-do-i-get-the-legendary-pokémon)
...
* [I don't like non-canon Tohomon types!](#i-dont-like-non-canon-pokémon-types)
* [I want the missing Tohomon back!](#i-want-the-missing-pokémon-back)
...
* [Base stats and TM learnsets](data/tohomon/base_stats/)
* [Level-up learnsets and evolution methods](data/tohomon/evos_attacks.asm)
* [Egg moves](data/tohomon/egg_moves.asm)
...
The regular version makes creative changes to Tohomon base stats and types, and to some move properties, mostly inspired by [Drayano's Sacred Gold and Storm Silver](https://gbatemp.net/threads/tohomon-sacred-gold-storm-silver.327567/). It also improves some translated terms that [Nob Ogasawara](https://twitter.com/dougdinsdale) [complained about](https://lparchive.org/Tohomon-Blue/code.html).
