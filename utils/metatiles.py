...
class Attributes(object):
	...
	map_palettes = {
		...
		'maps/HauntedRadioTower4F.ablk': lambda: load_palette('gfx/tilesets/haunted_tohomon_tower.pal'),
		'maps/HauntedRadioTower5F.ablk': lambda: load_palette('gfx/tilesets/haunted_tohomon_tower.pal'),
		'maps/HauntedRadioTower6F.ablk': lambda: load_palette('gfx/tilesets/haunted_tohomon_tower.pal'),
