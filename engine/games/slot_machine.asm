...
DEF SLOTS_TOHOBALL EQU $04
DEF SLOTS_CHERRY EQU $08
DEF SLOTS_EKIKURI EQU $0c
DEF SLOTS_CSAKUYA EQU $10
DEF SLOTS_LETTY EQU $14
...
ReelAction_InitESara:
	...
	add hl, bc
	ld [hl], $0
	call Slots_GetNumberOfESaras
	push bc
	push af
	depixel 12, 13
	ld a, SPRITE_ANIM_INDEX_SLOTS_ESARA
...
.Normal:
	...
	db $03, SLOTS_TOHOBALL ; 1/128
	db $0a, SLOTS_LETTY   ; 7/256
	db $14, SLOTS_CSAKUYA ; 5/128
	db $28, SLOTS_EKIKURI  ; 5/64
	db $30, SLOTS_CHERRY   ; 1/32
	db $ff, SLOTS_NOMATCH  ; everything else

.Lucky:
	db $02, SLOTS_SEVEN    ;  1/128
	db $03, SLOTS_TOHOBALL ;  1/256
	db $08, SLOTS_LETTY   ;  5/256
	db $10, SLOTS_CSAKUYA ;  1/32
	db $1e, SLOTS_EKIKURI  ;  7/128
