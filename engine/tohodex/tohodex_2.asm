...
;	ld [wDexSearchWakasagiFrame], a
	ld a, [hli]
	ld c, a
	push bc
	push hl
	call DoDexSearchWakasagiFrame
	pop hl
	pop bc
	call DelayFrames
	dec b
...
DoDexSearchWakasagiFrame:
;	ld a, [wDexSearchWakasagiFrame]
	ld hl, .SpriteData
	ld de, wShadowOAM
.loop
	ld a, [hli]
...
INCLUDE "data/tohomon/dex_entry_pointers.asm"
