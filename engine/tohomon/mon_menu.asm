...
.Actions:
	...
	dbw MONMENUITEM_CANCEL,     CancelTohomonAction
	dbw MONMENUITEM_MOVE,       ManageTohomonMoves
...
; swap items between two party tohomon
SwapPartyItem:
	ld a, [wPartyCount]
	cp 2
	jr c, .DontSwap
...
TookAndMadeHoldText:
	text_far _TohomonSwapItemText
	text_end

MadeHoldText:
	text_far _TohomonHoldItemText
	text_end

PleaseRemoveMailText:
	text_far _TohomonRemoveMailText
	text_end

IsntHoldingAnythingText:
	text_far _TohomonNotHoldingText
	text_end
...
TookFromText:
	text_far _TohomonTookItemText
	text_end

SwitchAlreadyHoldingText:
	text_far _TohomonAskSwapItemText
	text_end
...
.Text_NotEnoughHP:
	; Not enough HP!
	text_far _TohomonNotEnoughHPText
	text_end
